...
function create_fragment$h(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "triangles in circle",
				content: {
					"html": "<h1>matrices</h1><p><em>this is where my submarine head is about half-way down to the titanic.. <br>i can hear the fibres crackling.. but onward..</em></p><p>1 can be represented as a 1x1 matrix [1] - that's interesting in itself!</p><p>a matrix is a set of numbers, in rows and columns, in a rectangular array.</p><p>you can have a square matrix, like 2x2, or 3x3.. an nxn matrix.. a square matrix to the order n</p><p>or if there are two rows and three columns, then it is a 2x3 matrix.</p><p>and m is used. it's an mxn matrix. m is the rows and n is the columns.</p>",
					"markdown": "# matrices\n\n*this is where my submarine head is about half-way down to the titanic.. <br>\n\ni can hear the fibres crackling.. but onward..*\n\n1 can be represented as a 1x1 matrix [1] - that's interesting in itself!\n\na matrix is a set of numbers, in rows and columns, in a rectangular array.\n\nyou can have a square matrix, like 2x2, or 3x3.. an nxn matrix.. a square matrix to the order n\n\nor if there are two rows and three columns, then it is a 2x3 matrix.\n\nand m is used. it's an mxn matrix. m is the rows and n is the columns.\n\n"
				}
			}
		});
	...
	component_6 = new Component$7({
			props: {
				...
				description: "triangles in circle",
				content: {
					"html": "<p></p><p>the vector will be 'pointing' at x = cos(30), y = sin(30)</p><p>the vector is also the hypotenuse of a triangle. and remember it is length 1</p><p>sin is opposite over hypotenuse. the right angle is a vertical line from the point<br>meeting the x line (the line where y==0)</p><p>the y line, where x == 0, can have a horizontal line to the point, making the right angle for the triangle when look at cosine. cosine is adjacent over hypotenuse.</p><p>the 2 'lines', the vertical and horizontal lines, make up a rectangle</p><p>the triangle is half that rectangle</p><p></p><p>here we are supposed to think about how an equilateral triangle with side lengths 1 has three 60 degrees angles..</p><p>and if you chop it in half you get a triangle with a right angle, a 30 degree angle and a 60 degree angle</p><p>so the y value becomes a half.. 1/2</p><p>sin(30) == 1/2 or 0.5</p><p>a squared + b squared = c squared</p><p>a squared + b squared = 1</p><p>sin(30) .. 30 == opposite / hypotenuse and since hypotenuse is 1, just opposite = 1/2</p><p>cos(30) = adjacent / hypotenuse =</p><p>a squared = c squared - b squared</p><p>adjacent squared == 1 - 1/2 squared = 1 - 1/4 = 3/4</p><p>adjacent == square root of (3/4) = square root of 3 / square root of 4 <br>= (square root of 3) / 2</p><p>this is about 0.866</p><p>angle is 30.. x (horizontal) is root 3 over 2.. y (vertical) is 1/2.... (+0.866, +0.5)</p><p>angle is 60.. x is 1/2.. y is root 3 over 2.... (+0.5, +0.866)</p><p></p><p></p><p></p>",
