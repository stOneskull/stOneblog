...
function create_fragment$n(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "matrices",
				content: {
					"html": "<h1>matrices</h1><p><em>this is where my submarine head is about half-way down to the titanic.. <br>i can hear the fibres crackling.. but onward..</em></p><p><em>note: i don't know what i'm talking about. don't put this in your schoolwork.</em></p><p></p><p>1 can be represented as a 1x1 matrix [1] - that's interesting in itself!</p><p>[23] is 23</p><p>and a number by itself when interacting with the matrix is a scalar</p><p></p><p>a matrix is a set of numbers, in rows and columns, in a rectangular array.</p><p>you can have a square matrix, like 2x2, or 3x3.. <br>an n x n matrix.. <br>a square matrix to the order n</p><p>or if there are two rows and three columns, then it is a 2x3 matrix.</p><p>and m is used. it's an m x n matrix. <br>m is the rows and n is the columns.</p><p>[ 3 5 6]<br>[ 2 1 0 ] ... a 2x3 matrix of some numbers.</p><p></p><p>transposing means making the rows into columns and the columns, rows.</p><p>[ 3 2 ]<br>[ 5 1 ]<br>[ 6 0 ]... a 3x2 matrix is the transpose of a 2x3 matrix</p>",
