...
function create_fragment$i(ctx) {
	...
	component_8 = new Component$9({
			props: {
				...
				description: "matrices",
				content: {
					"html": "<p></p><p><em>what is it? </em></p><p>well if you multiply another matrix with it you get back the same matrix</p><p><em>what does that mean?</em></p><p>it's like multiplying a number by 1.. 23 x 1 == 23 </p><p>and here we go.. it's what it's all about.. </p><p>matrix multiplication</p><p><em>well it's what i'm here waiting for anyway</em></p>",
					"markdown": "\n\n*what is it? *\n\nwell if you multiply another matrix with it you get back the same matrix\n\n*what does that mean?*\n\nit's like multiplying a number by 1.. 23 x 1 == 23\n\nand here we go.. it's what it's all about..\n\nmatrix multiplication\n\n*well it's what i'm here waiting for anyway*\n\n"
				}
			}
		});
