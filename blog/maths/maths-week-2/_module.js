...
function create_fragment$i(ctx) {
	...
	component_13 = new Component$e({
			props: {
				...
				description: "matrices",
				content: {
					"html": "<p><em>i'm not sure where i'm going with this.. maybe a step back to vectors next week</em></p><p><em>points..</em></p><p><code>columns = list(zip(*matrix))</code></p>",
					"markdown": "*i'm not sure where i'm going with this.. maybe a step back to vectors next week*\n\n*points..*\n\n`columns = list(zip(*matrix))`\n\n"
				}
			}
		});
