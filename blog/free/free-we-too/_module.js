...
function create_fragment$9(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "rolling rolling rollling",
				content: {
					"html": "<h1>maybe 180</h1><p>i've been doing well moving log-ins, etc, but i've been thinking..</p><p>what happens when i die? someone else registers my domains</p><p>then they get any emails (log-ins) from the domain.</p><p>do i care? it's a question i've been thinking about for a day, and yeah i do.</p><p>a big part of the day was thinking 'fastmail' or 'protonmail'?</p><p>protonmail is outside ASiO reading it.. not that i'm criminal, it's just a point.<br></p><p>and you get a password manager and a vpn.. so i'm going that angle now.<br></p><p>log-ins using various email aliases from proton.</p><p>reducing the custom domains and email associated.</p><p>i think i might still keep migadu. i'll see how it goes. i gotta have a couple custom emails.. it's fun.</p><p>seriously interesting how i started this blog with these issues in my head, and this topic at the forefront. and then it changed as i went through it.</p><p>what i thought was freeing wasn't just getting out of dependence on the G but finding my own solution. i thought it was just using custom domains but the issue of what happens later got me to what is more freeing.</p><p>my mind feels freer going through that. my answer to this first thing was proton.</p><p>there is a free account which is great and then some value-added paid plans.</p><p>you can use my referral and we both get an extra free month of mail-plus</p><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://pr.tn/ref/HQJ9F871AN1G\">sign up to proton mail</a></p>",
