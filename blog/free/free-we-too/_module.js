...
function create_fragment$9(ctx) {
	...
	component_4 = new Component$5({
			props: {
				...
				description: "rolling rolling rollling",
				content: {
					"html": "<h1>and then</h1><p></p><p>i'm keeping my desktop on windows for the time being. it's just easier and i don't want an extra headache at the moment.</p><p>laptop moving soon. although not to Pop OS..</p><p>it's Kali..</p>",
