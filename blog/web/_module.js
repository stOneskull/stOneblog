...
function create_fragment$7(ctx) {
	...
	component_2 = new Component$3({
			props: {
				...
				description: "bit of fun and expression",
				content: {
					"html": "<h2>web</h2><h4><em>hey what..</em></h4><p></p><p>i was going to call the headline 'clickbait' and then talk about the title.. </p><p>but that's what clickbait is. just having this title will bring in some traffic.</p><p>even though this this article doesn't really answer the stupid question.</p><p>they are both good and there a pros and cons about both.</p>",
