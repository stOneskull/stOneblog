...
function create_fragment$7(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<p><em>my favourite computer language..</em></p><p><strong>Python</strong></p><p>3.12 is coming out soon.</p><p>i like to use the latest but i have been using 3.10 rather than 3.11</p><p>there was a program i downloaded from github that wouldn't work with 3.11. some dependency problem or something. 3.11 was too new. so i started using 3.10. it's nice.</p><p>i don't really know the difference in the very latest editions. i haven't used the walrus operator yet. or data classes. i want to, just haven't yet. i don't use type-annotation. i haven'y tried the asyncio stuff. i'm quite a novice. i only just recently used the os module. i've use random and time mostly.</p><p>i started using conda for some things. it's good you can choose the python version to put in the environment. venv just uses the latest python you have. but i'm kinda new to it all. bit of this, bit of that. i often just install into the base conda environment. i'm a bit messy.</p><p>3.12 is going to improve f-strings which is cool. i really like f-strings.</p><p></p><p><strong>BASIC</strong></p><p><em>my first computer language</em></p><p>when i was about 10, my father's father died and i got $1000 from his will.</p><p>before i could think about it, i knew i wanted a commodore 64. that cost about $500. then i got a tv and some furniture stuff. i should've got a disk drive but oh well.</p><p>i bought one game. it was Labyrinth. it was great.</p><p>it was so unbelievably slow loading games on tape. i could start loading a game when dinner was ready, go eat dinner, and the game would still be loading when i got back. kids today wouldn't be able to handle how slow it was.</p><p>anyway, i needed more than that one game. i didn't have much choice but to learn some BASIC. luckily the library had some books, and i typed in programs from them. then modified them. i didn't get into graphics unfortunately. i got zork from somewhere, or something similar to zork. and i was able to read the BASIC program. that's about as far as i got.</p><p>one day i met a guy who got the same bus as me to my new school and he had a c64 too. and he games and knew how to copy the tapes. we became good friends and i started copying games. and i didn't use BASIC except for something like mother's day where i would draw a mother's day card on the tv.</p><p>and then it was the same with the Amiga. at first it was fun playing with the Amiga BASIC. i really liked that you didn't need line numbers, and could give subroutines names. but then i met a guy who had connections to copy the latest of Amiga software. i had hundreds and hundreds of floppies and didn't really use the BASIC anymore.</p><p>and since then, all i did that was anything like programming were things like config files or dos batch files. later on a little bit of html. i still hardly know javascript. i have learnt a little bit more html, and just a tiny bit of css. i'm going to learn more though. it gets easier with time and practice. the practice has been a cycle. 0 to 1 and back.</p><p><strong>C#</strong> </p><p>i got to a point where i wanted to program again and i was going to go with C#.</p><p>it would've been an interesting alternative timeline but at the time, i had started to use linux. i liked exploring different linux distros, to try them out. at that time, i had an itch to program. i thought C# seemed good, and that it was like the default language to write for Unity. and i had a Sony Vita. there was thing called playstation mobile. and they provided a SDK which used C#. it didn't work on linux though. there was something about .NET not working. you were supposed to use a thing called mono but the latest version of .NET was compatible with mono yet or something.. and then a coincidence of two things happened.</p><p>going back before the vita, around the time of the Sony PSP. it got hacked and people were making homebrew for it. i thought it would be cool to write my own game onto the PSP. i learnt how to hack the PSP myself and got into configuring, theming, installing tools and homebrew, and honestly, piracy. not just PSP games, PS1 games (tony hawk is awesome!) and emulated games like nes and sega console games. guys were using a language called Python to make homebrew. (shout out to wololo - legend). i almost tried learning it, but again, like before.. i just played games. </p><p>so yeah, i was playing with linux, had an itch, C# was annoying me, and an old friend popped up in my life again after years. he is a computer programmer. he has been since a kid. he suggested i tried Python. when he mentioned it, i remembered about the PSP, and i thought it made sense to go with that. it felt independent, as in not owned by a company like java and c# seem to be. plus linux has python built in!</p><p>i think that's enough rambling for now.</p><p>i'll write more on this in a week..</p><p></p>",
					"markdown": "*my favourite computer language..*\n\n**Python**\n\n3\\.12 is coming out soon.\n\ni like to use the latest but i have been using 3.10 rather than 3.11\n\nthere was a program i downloaded from github that wouldn't work with 3.11. some dependency problem or something. 3.11 was too new. so i started using 3.10. it's nice.\n\ni don't really know the difference in the very latest editions. i haven't used the walrus operator yet. or data classes. i want to, just haven't yet. i don't use type-annotation. i haven'y tried the asyncio stuff. i'm quite a novice. i only just recently used the os module. i've use random and time mostly.\n\ni started using conda for some things. it's good you can choose the python version to put in the environment. venv just uses the latest python you have. but i'm kinda new to it all. bit of this, bit of that. i often just install into the base conda environment. i'm a bit messy.\n\n3\\.12 is going to improve f-strings which is cool. i really like f-strings.\n\n\n\n**BASIC**\n\n*my first computer language*\n\nwhen i was about 10, my father's father died and i got $1000 from his will.\n\nbefore i could think about it, i knew i wanted a commodore 64. that cost about $500. then i got a tv and some furniture stuff. i should've got a disk drive but oh well.\n\ni bought one game. it was Labyrinth. it was great.\n\nit was so unbelievably slow loading games on tape. i could start loading a game when dinner was ready, go eat dinner, and the game would still be loading when i got back. kids today wouldn't be able to handle how slow it was.\n\nanyway, i needed more than that one game. i didn't have much choice but to learn some BASIC. luckily the library had some books, and i typed in programs from them. then modified them. i didn't get into graphics unfortunately. i got zork from somewhere, or something similar to zork. and i was able to read the BASIC program. that's about as far as i got.\n\none day i met a guy who got the same bus as me to my new school and he had a c64 too. and he games and knew how to copy the tapes. we became good friends and i started copying games. and i didn't use BASIC except for something like mother's day where i would draw a mother's day card on the tv.\n\nand then it was the same with the Amiga. at first it was fun playing with the Amiga BASIC. i really liked that you didn't need line numbers, and could give subroutines names. but then i met a guy who had connections to copy the latest of Amiga software. i had hundreds and hundreds of floppies and didn't really use the BASIC anymore.\n\nand since then, all i did that was anything like programming were things like config files or dos batch files. later on a little bit of html. i still hardly know javascript. i have learnt a little bit more html, and just a tiny bit of css. i'm going to learn more though. it gets easier with time and practice. the practice has been a cycle. 0 to 1 and back.\n\n**C#**\n\ni got to a point where i wanted to program again and i was going to go with C#.\n\nit would've been an interesting alternative timeline but at the time, i had started to use linux. i liked exploring different linux distros, to try them out. at that time, i had an itch to program. i thought C# seemed good, and that it was like the default language to write for Unity. and i had a Sony Vita. there was thing called playstation mobile. and they provided a SDK which used C#. it didn't work on linux though. there was something about .NET not working. you were supposed to use a thing called mono but the latest version of .NET was compatible with mono yet or something.. and then a coincidence of two things happened.\n\ngoing back before the vita, around the time of the Sony PSP. it got hacked and people were making homebrew for it. i thought it would be cool to write my own game onto the PSP. i learnt how to hack the PSP myself and got into configuring, theming, installing tools and homebrew, and honestly, piracy. not just PSP games, PS1 games (tony hawk is awesome!) and emulated games like nes and sega console games. guys were using a language called Python to make homebrew. (shout out to wololo - legend). i almost tried learning it, but again, like before.. i just played games.\n\nso yeah, i was playing with linux, had an itch, C# was annoying me, and an old friend popped up in my life again after years. he is a computer programmer. he has been since a kid. he suggested i tried Python. when he mentioned it, i remembered about the PSP, and i thought it made sense to go with that. it felt independent, as in not owned by a company like java and c# seem to be. plus linux has python built in!\n\ni think that's enough rambling for now.\n\ni'll write more on this in a week..\n\n\n\n"
				}
			}
		});
