...
function create_fragment$8(ctx) {
	...
	component_4 = new Component$5({
			props: {
				...
				description: "blackboard",
				content: {
					"html": "<p><em>Didn't really have a topic for today.</em></p><p>I'm working on a controversial post and really not sure if I should post it. I don't really want to get much into politics or religion. But I think this topic is important..</p><p> Tomorrow I think is a continuation of another post.. A 'weekly update' post I'm doing inside some posts.</p><p>So today I thought I'd mention 𝕏 This is all the buzz, in the news.. I wonder if someone reads this in the future far away. I wonder what happens with all this... </p><p>I think Elon Musk planned to make twitter into <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link link\" href=\"http://x.com\">x.com</a> since he before he bought it. The domain is his baby, he made sure to keep it when splitting up from Paypal. I kinda like it. A new change.</p><p>But anyway, clogging along..</p><p>I wonder what happens when I die.. on a few different levels. And topics..</p>",
					"markdown": "*Didn't really have a topic for today.*\n\nI'm working on a controversial post and really not sure if I should post it. I don't really want to get much into politics or religion. But I think this topic is important..\n\nTomorrow I think is a continuation of another post.. A 'weekly update' post I'm doing inside some posts.\n\nSo today I thought I'd mention 𝕏 This is all the buzz, in the news.. I wonder if someone reads this in the future far away. I wonder what happens with all this...\n\nI think Elon Musk planned to make twitter into [x.com](<http://x.com>) since he before he bought it. The domain is his baby, he made sure to keep it when splitting up from Paypal. I kinda like it. A new change.\n\nBut anyway, clogging along..\n\nI wonder what happens when I die.. on a few different levels. And topics..\n\n"
				}
			}
		});
