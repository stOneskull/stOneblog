...
function create_fragment$9(ctx) {
	...
	component_4 = new Component$5({
			props: {
				...
				description: "These are my blog posts and they are wonderful.",
				content: {
					"html": "<p><a href=\"https://www.stoneskull.me/2023-08/blogs/blogs-week-2\"><-- blogs week 2</a></p>",
					"markdown": "[<-- blogs week 2](https://www.stoneskull.me/2023-08/blogs/blogs-week-2)"
				}
			}
		});
	...
	component_5 = new Component$6({
			props: {
				...
				description: "These are my blog posts and they are wonderful.",
				content: {
					"html": "<p><em>Some more text that's italicized to make an impact.</em></p><p><em>back, baby.</em></p><p>I gotta write again.</p><p></p><p>I know. I'm like a broken record.</p><p>I was going to say it's writer's block, but it's more like analysis paralysis.</p><p>I've been analyzing, to the point of going neurotic. Maybe I said that before too.</p><p>Twin Peaks has become more than an obsession. It's my golden shovel. I've been digging into all kinds of shit. All the world civilizations and their history, their cultures. Then blending into this thing called Theosophy.</p><p>Theosophy goes into just about every topic. It's about learning the truth. Learning about all the beliefs and it really is interesting, especially when there are connections between them. Astrology is probably the main thing. The sky and its wonders.</p><p>I've spent a lot of my life learning about different aspects, but never really embracing them all together as much as now. Yeah, Sandman the comic book series is a great example of it. And Invisibles, another of my favourites. And Robert Anton Wilson would do it too, for sure. It's like tying everything together. For a good purpose. For the Truth. For Logos.</p><p>ps. gotta fix up the moon pages, past and future</p><p></p>",
