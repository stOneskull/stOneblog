...
function create_fragment$i(ctx) {
	...
	component_4 = new Component$5({
			props: {
				...
				image: {
					"alt": "wreath",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/laurel%20wreath-8133-9439789523825716405c6a782ab39368@2x.jpg1707823418182"
				},
				title: "laura",
				description: "find laura"
			}
	...
	component_5 = new Component$6({
			props: {
				...
				description: "find laura",
				content: {
					"html": "<p>This opens the door to Delphi and the oracle, Apollo and Python</p><blockquote><p><em>With laurer corouned as a conquerour<br>And there he lyueth in ioye and in honour .</em></p><p>[<em>With laurel crowned as conqueror<br>There he lived in joy and honour</em>]</p><p>Geoffrey Chaucer, The Knight's Tale</p></blockquote>",
					"markdown": "This opens the door to Delphi and the oracle, Apollo and Python\n\n> *With laurer corouned as a conquerour<br>\n> \n> And there he lyueth in ioye and in honour .*\n> \n> [*With laurel crowned as conqueror<br>\n> \n> There he lived in joy and honour*]\n> \n> Geoffrey Chaucer, The Knight's Tale\n\n"
				}
			}
		});
	...
	component_6 = new Component$7({
			props: {
				...
				image: {
					"alt": "meanwhile",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/meanwhile.jpg1704852534006"
				},
				title: "laura",
				description: "find laura"
			}
	...
	component_7 = new Component$8({
			props: {
				...
				image: {
					"alt": "dougietree",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/dougietree.jpg1704852424421"
				},
				title: "laura",
				description: "find laura"
			}
	...
	component_8 = new Component$9({
			props: {
				...
				description: "find laura",
				content: {
					"html": "<p>Meanwhile, Apollo and Daphne</p>",
					"markdown": "Meanwhile, Apollo and Daphne\n\n\n"
				}
			}
		});
	...
	component_9 = new Component$a({
			props: {
				...
				image: {
					"alt": "meanwhile, apollo and daphne",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/th-932238077.jpg1707824292799"
				},
				title: "laura",
				description: "find laura"
			}
	...
	component_10 = new Component$b({
			props: {
				...
				description: "find laura",
				content: {
					"html": "<p><em>hey! now we're getting somewhere! this is starting to look good!</em></p><p><strong>Daphne the river nymph</strong></p><blockquote><p>(<em>josie the wood nymph tick is a branch!</em>)</p><p>…<br>Well, there's the story of the wood nymph Syrinx who ran away from Pan, and got turned into a reed, from which Pan made a flute</p><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://en.wikipedia.org/wiki/Syrinx\">https://en.wikipedia.org/wiki/Syrinx</a></p><p>And there's a mountain nymph who was turned into a pine tree, called Pitys</p><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://en.wikipedia.org/wiki/Pitys_(mythology)\">https://en.wikipedia.org/wiki/Pitys_(mythology)</a></p></blockquote><p></p><p>laurels dance..</p><p><em>long hair like leo!</em></p>",
					"markdown": "*hey! now we're getting somewhere! this is starting to look good!*\n\n**Daphne the river nymph**\n\n> (*josie the wood nymph tick is a branch!*)\n> \n> …<br>\n> \n> Well, there's the story of the wood nymph Syrinx who ran away from Pan, and got turned into a reed, from which Pan made a flute\n> \n> [https://en.wikipedia.org/wiki/Syrinx](<https://en.wikipedia.org/wiki/Syrinx>)\n> \n> And there's a mountain nymph who was turned into a pine tree, called Pitys\n> \n> [https://en.wikipedia.org/wiki/Pitys\\_(mythology)](<https://en.wikipedia.org/wiki/Pitys_(mythology)>)\n\n\n\nlaurels dance..\n\n*long hair like leo!*\n\n"
				}
			}
		});
	...
	component_11 = new Component$c({
			props: {
				...
				image: {
					"alt": "laurels dance",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/Apollo_and_Daphne,_fresco_from_South_wall_of_Casa.jpg1707825137503"
				},
				title: "laura",
				description: "find laura"
			}
	...
	component_13 = new Component$e({
			props: {
				...
				image: {
					"alt": "zone",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/th-765773898.jpg1707826790862"
				},
				title: "laura",
				description: "find laura"
			}
	...
	component_14 = new Component$f({
			props: {
				...
				image: {
					"alt": "bonsai",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/th-1719724600.jpg1707826730727"
				},
				title: "laura",
				description: "find laura"
			}
