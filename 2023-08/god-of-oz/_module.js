...
function create_fragment$a(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "in the aether",
				content: {
					"html": "<h1>book</h1><p>i'm writing a book. it's called God of Oz. </p><p>below is just a draft idea of the cover. i will not be using the word whimsical at all:</p>",
