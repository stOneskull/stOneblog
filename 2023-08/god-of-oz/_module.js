...
function create_fragment$f(ctx) {
	...
	component_2 = new Component$3({
			props: {
				...
				image: {
					"alt": "yinyang",
					"src": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/1673609247972Harmony.jpg",
	...
	component_5 = new Component$6({
			props: {
				...
				description: "in the aether",
				content: {
					"html": "<p>i'm using LibreOffice.</p><p>it's very impressive and underrated. now and then i get tempted toward ms office but sticking to this office has been rewarding. i mainly use Calc, and sometimes i think it is psychic. knowing what i want to do. it's great.</p><p>and preparing for writing a book, i learned more about Writer. like setting up the fonts and sizes, and layouts and stuff, so there's a nice and consistent style, and then each chapter, its own document in that template. this way is especially good in the case(s) of switching chapter positions within the main book. The main book document waits til all the chapters are ready and done.</p><p></p><p>and it's gonna take time. a whole lot of precious time.</p><p>it's going to take patience and time.</p>",
					"markdown": "i'm using LibreOffice.\n\nit's very impressive and underrated. now and then i get tempted toward ms office but sticking to this office has been rewarding. i mainly use Calc, and sometimes i think it is psychic. knowing what i want to do. it's great.\n\nand preparing for writing a book, i learned more about Writer. like setting up the fonts and sizes, and layouts and stuff, so there's a nice and consistent style, and then each chapter, its own document in that template. this way is especially good in the case(s) of switching chapter positions within the main book. The main book document waits til all the chapters are ready and done.\n\n\n\nand it's gonna take time. a whole lot of precious time.\n\nit's going to take patience and time.\n\n"
				}
			}
		});
	...
	component_7 = new Component$8({
			props: {
				...
				description: "in the aether",
				content: {
					"html": "<h1 id=\"email\">email</h1>\n<p><a href=\"mailto:godofoz@hotmail.com\">godofoz@hotmail.com</a></p>",
					"markdown": "# email\n\n[godofoz@hotmail.com](<mailto:godofoz@hotmail.com>)\n\n"
				}
			}
		});
	...
	component_8 = new Component$9({
			props: {
				...
				description: "in the aether",
				content: {
					"html": "<h1>discussion forum</h1><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://godofoz.com\">God of Oz</a></p>",
					"markdown": "# discussion forum\n\n[God of Oz](<https://godofoz.com>)\n\n"
				}
			}
		});
	...
	component_10 = new Component$b({
			props: {
				...
				description: "in the aether",
				content: {
					"html": "<p><em>zero one two three</em></p><p><em>male and female and baby</em></p><p><em>spiral family</em></p>",
					"markdown": "*zero one two three*\n\n*male and female and baby*\n\n*spiral family*\n\n"
				}
			}
		});
	...
	component_11 = new Component$c({
			props: {
				...
				image: {
					"alt": "complimentary opposites",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/61Wcwe8xwOL.jpg1558501225864"
				},
				title: "god of oz",
				description: "in the aether"
			}
