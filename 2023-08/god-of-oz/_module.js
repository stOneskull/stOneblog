...
function create_fragment$8(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "in the aether",
				content: {
					"html": "<h1>my book</h1><p>just a draft idea of the cover. i will not be using the word whimsical at all:</p>",
					"markdown": "# my book\n\njust a draft idea of the cover. i will not be using the word whimsical at all:\n\n"
				}
			}
		});
