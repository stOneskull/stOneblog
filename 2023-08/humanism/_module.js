...
function create_fragment$c(ctx) {
	...
	component_0 = new Component({
			props: {
				...
				image: {
					"alt": "humanism",
					"src": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/1691995065920contra3.jpeg",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/1691995065920contra3.jpeg",
					"size": 7
				},
				title: "humanism",
				description: "contradctions"
			}
		});
	...
	component_2 = new Component$3({
			props: {
				...
				image: {
					"alt": "contra1",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/contra1.jpeg1691994942232"
				},
				title: "humanism",
				description: "contradctions",
				superhead: "2023-08-13",
				heading: "humanism"
			}
		});
	...
	component_3 = new Component$4({
			props: {
				...
				description: "contradctions",
				content: {
					"html": "<p>I didn't really want to talk about this..</p><p><em>But I'm inspired.</em></p><p>But I'm tired.</p><p><em>Firstly, the contradictions in the New Testament are nothing..</em></p><p><em>Secondly, official humanism is pee'ing me off today..</em></p><p><em>Thirdly, I think this will be my last post on religion for a bit.</em></p>",
					"markdown": "I didn't really want to talk about this..\n\n*But I'm inspired.*\n\nBut I'm tired.\n\n*Firstly, the contradictions in the New Testament are nothing..*\n\n*Secondly, official humanism is pee'ing me off today..*\n\n*Thirdly, I think this will be my last post on religion for a bit.*\n\n"
				}
			}
		});
	...
	component_5 = new Component$6({
			props: {
				...
				description: "contradctions",
				content: {
					"html": "<h1>Grr..</h1><p></p><p><em>I didn't really want to talk about this..</em></p><p><em>But I'm inspired.</em></p><p></p><p><em>Firstly, the contradictions in the New Testament are nothing..</em></p><p><em>Secondly, official humanism is pee'ing me off today..</em></p><p><em>Thirdly, I think this will be my last post on religion for a bit.</em></p>",
	...
	component_6 = new Component$7({
			props: {
				...
				description: "contradctions",
				content: {
					"html": "<p><em>So, I used to be atheist.</em></p><p><em>I was a militant atheist. An anti-theist. I'd want to convert you to atheism. I'd argue with religious people every day. And I'd want to win the debate. I was such a hypocrite.</em></p><p><em>I'm not atheist anymore. I'm a God-believing Buddhist. I love Jesus and Krisna. Love and Goodness. You know?</em></p><p><em>I also have logic and critical thinking ingrained in me. I'm not stupid. I hate it when atheists think they know more than others, and think they are intellectually superior. They are often so fragile in their spirit, and that brings me to a vomit.</em></p><p><em>I have nothing against atheism really. It's really the anti-theists.. the group of atheists who act like missionaries, wanting to convert others to atheism, who I'm talking about. I was like them and see my past self in them.</em></p><p></p>",
					"markdown": "*So, I used to be atheist.*\n\n*I was a militant atheist. An anti-theist. I'd want to convert you to atheism. I'd argue with religious people every day. And I'd want to win the debate. I was such a hypocrite.*\n\n*I'm not atheist anymore. I'm a God-believing Buddhist. I love Jesus and Krisna. Love and Goodness. You know?*\n\n*I also have logic and critical thinking ingrained in me. I'm not stupid. I hate it when atheists think they know more than others, and think they are intellectually superior. They are often so fragile in their spirit, and that brings me to a vomit.*\n\n*I have nothing against atheism really. It's really the anti-theists.. the group of atheists who act like missionaries, wanting to convert others to atheism, who I'm talking about. I was like them and see my past self in them.*\n\n\n\n"
				}
			}
		});
	...
	component_7 = new Component$8({
			props: {
				...
				image: {
					"alt": "testaments",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/contra2.jpeg1691995000356"
				},
				title: "humanism",
				description: "contradctions"
			}
	...
	component_8 = new Component$9({
			props: {
				...
				description: "contradctions",
				content: {
					"html": "<p><em>So, what's your testament, Mr Atheist? </em></p><p><em>It's a counter to another's, isn't it. You don't have your own.</em></p><p><em>You are an NPC really. You depend on others for your own beliefs. You actually don't have any beliefs. You have mocking. You have caustic sarcasm. You have hate. And these things are covering up your insecurities.</em></p><p></p><p><em>So, you say 'Wrong! Actoowally, I'm a humanist!' and then you write articles like this..</em></p><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://americanhumanist.org/what-is-humanism/reasons-humanists-reject-bible/\">https://americanhumanist.org/what-is-humanism/reasons-humanists-reject-bible/</a></p><p><em>and it seems to me that humanism is just another name for anti-theism.</em></p><p><strong>and it's worse than that because of the anti-logic.</strong></p><p><em>Your heading: \"Cruelty in Basic Christian Teachings\"..</em></p><p><em>You attack Christians, then quote a bunch of Old Testament chapters and blame Christians for it, and make jews victims of it! </em></p><p><em>You aren't humanist. You are stupid.</em></p><p><em>Rant over. </em></p><p><em>Peace.</em></p>",
					"markdown": "*So, what's your testament, Mr Atheist? *\n\n*It's a counter to another's, isn't it. You don't have your own.*\n\n*You are an NPC really. You depend on others for your own beliefs. You actually don't have any beliefs. You have mocking. You have caustic sarcasm. You have hate. And these things are covering up your insecurities.*\n\n\n\n*So, you say 'Wrong! Actoowally, I'm a humanist!' and then you write articles like this..*\n\n[https://americanhumanist.org/what-is-humanism/reasons-humanists-reject-bible/](<https://americanhumanist.org/what-is-humanism/reasons-humanists-reject-bible/>)\n\n*and it seems to me that humanism is just another name for anti-theism.*\n\n**and it's worse than that because of the anti-logic.**\n\n*Your heading: \"Cruelty in Basic Christian Teachings\"..*\n\n*You attack Christians, then quote a bunch of Old Testament chapters and blame Christians for it, and make jews victims of it! *\n\n*You aren't humanist. You are stupid.*\n\n*Rant over. *\n\n*Peace.*\n\n"
				}
			}
		});
