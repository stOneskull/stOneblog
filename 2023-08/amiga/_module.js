...
function create_fragment$9(ctx) {
	...
	component_0 = new Component({
			props: {
				...
				image: {
					"alt": "amiga",
					"src": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/1691394269977amiga.webp",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/1691394269977amiga.webp",
					"size": 24
				},
				title: "amiga",
	...
	component_3 = new Component$4({
			props: {
				...
				description: "what a special machine",
				quote: {
					"html": "<p>“Amiga will never die.”</p>",
					"markdown": "“Amiga will never die.”\n\n"
				},
				attribution: "- U Gnoeet"
			}
		});
	...
	component_5 = new Component$6({
			props: {
				...
				description: "what a special machine",
				content: {
					"html": "<p><em>Some more text that's italicized to make an impact.</em></p><p>I've been writing pretend blogs in my mind.</p><p>I've been doing stuff and thinking about a blog for the things.</p><p>Like, I never had a NAS before. I never used RAID 1 with two drives in a NAS and stuff.</p><p>I never bought a whole duck before. I've bought duck that's already cooked. Never my own blank slate duck. I've cooked many chickens. And I love it.</p><p>I'm quite excited to cook my duck. There are so many paths that it could take. So many possibilities of where this duck will go. Before it goes in my mouth and stomach.</p><p>Some blogs might be for my own viewing. It's all part of this journey thing.</p><p>The NAS is exciting too. Gotta wait til the router and ethernet cables arrive. Then I'll do a post about it.</p>",
					"markdown": "*Some more text that's italicized to make an impact.*\n\nI've been writing pretend blogs in my mind.\n\nI've been doing stuff and thinking about a blog for the things.\n\nLike, I never had a NAS before. I never used RAID 1 with two drives in a NAS and stuff.\n\nI never bought a whole duck before. I've bought duck that's already cooked. Never my own blank slate duck. I've cooked many chickens. And I love it.\n\nI'm quite excited to cook my duck. There are so many paths that it could take. So many possibilities of where this duck will go. Before it goes in my mouth and stomach.\n\nSome blogs might be for my own viewing. It's all part of this journey thing.\n\nThe NAS is exciting too. Gotta wait til the router and ethernet cables arrive. Then I'll do a post about it.\n\n"
				}
			}
		});
