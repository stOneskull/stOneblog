...
function create_fragment$c(ctx) {
	...
	component_8 = new Component$9({
			props: {
				...
				description: "lxd vs docker",
				content: {
					"html": "<h2>leapt..</h2><h4><em>i didn't read the f'n manual</em></h4><p></p><p>nothing went wrong (as yet). i just dove a bit quick, i think.</p><p>of course, before writing this article i looked up a couple of informative webpages on the internet, about containers and docker and lxd. but i didn't really read them before just deciding to install ubuntu on lxd. hmm.. well, i did, and i suppose, it's meant to be!</p><p>while waiting, i saw there were containers for fedora, centos, and things like busybox.. lxd and docker containers..</p><p>i saw there is also a docker ubuntu container. now that's doubly interesting since i can't understand how to use this lxd ubuntu installation. the terminal wants a login and password. ubuntu ubuntu doesn't work. neither does by nas account. i can't really find answers..</p><p>so, ha, i'm going to delete it. then i'm going to try the docker version..</p>",
					"markdown": "## leapt..\n\n#### *i didn't read the f'n manual*\n\n\n\nnothing went wrong (as yet). i just dove a bit quick, i think.\n\nof course, before writing this article i looked up a couple of informative webpages on the internet, about containers and docker and lxd. but i didn't really read them before just deciding to install ubuntu on lxd. hmm.. well, i did, and i suppose, it's meant to be!\n\nwhile waiting, i saw there were containers for fedora, centos, and things like busybox.. lxd and docker containers..\n\ni saw there is also a docker ubuntu container. now that's doubly interesting since i can't understand how to use this lxd ubuntu installation. the terminal wants a login and password. ubuntu ubuntu doesn't work. neither does by nas account. i can't really find answers..\n\nso, ha, i'm going to delete it. then i'm going to try the docker version..\n\n"
				}
			}
		});
