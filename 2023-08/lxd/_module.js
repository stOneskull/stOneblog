...
function create_fragment$a(ctx) {
	...
	component_5 = new Component$6({
			props: {
				...
				description: "lxd vs docker",
				content: {
					"html": "<h2>what is a container?</h2><h4><em>first things first..</em></h4><p></p><p>i guess the zeroth thing is this is linux. i've used a vm or two, which can be considered containers, on windows before. vmware and virtualbox are the two main runners of these. a vm lets an os run inside an os. there are other ones like dosbox and scummvm that are like mini operating systems inside a container, the os made to serve the one main task. </p><p>so, a container is a box, like a desktop computer is a box. there's stuff inside the box which has everything needed to operate and run a system. power and adapters and peripherals and cables.. other things are still needed to do do anything with a box. all these things, this system, is what we must get used to. if we want to see what a conputer is doing, we have to plug in a video screen. if we want to input commands to the box, we plug in a keyboard and a mouse. </p><p>a</p>",
					"markdown": "## what is a container?\n\n#### *first things first..*\n\n\n\ni guess the zeroth thing is this is linux. i've used a vm or two, which can be considered containers, on windows before. vmware and virtualbox are the two main runners of these. a vm lets an os run inside an os. there are other ones like dosbox and scummvm that are like mini operating systems inside a container, the os made to serve the one main task.\n\nso, a container is a box, like a desktop computer is a box. there's stuff inside the box which has everything needed to operate and run a system. power and adapters and peripherals and cables.. other things are still needed to do do anything with a box. all these things, this system, is what we must get used to. if we want to see what a conputer is doing, we have to plug in a video screen. if we want to input commands to the box, we plug in a keyboard and a mouse.\n\na\n\n"
				}
			}
		});
