...
function create_fragment$b(ctx) {
	...
	component_8 = new Component$9({
			props: {
				...
				description: "lxd vs docker",
				content: {
					"html": "<h2>leapt..</h2><h4><em>i didn't read the f'n manual</em></h4><p></p><p>nothing went wrong (as yet). i just dove a bit quick, i think.</p><p>of course, before writing this article i looked up a couple of informative webpages on the internet, about containers and docker and lxd. but i didn't really read them before just deciding to install ubuntu on lxd. hmm.. well, i did, and i suppose, it's meant to be!</p>",
