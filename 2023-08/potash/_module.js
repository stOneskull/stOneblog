...
function create_fragment$a(ctx) {
	...
	component_6 = new Component$7({
			props: {
				...
				description: "pot ash",
				content: {
					"html": "<p><em>Potassium pearls under paraffin oil. Original size of the largest pearl: 0.5&nbsp;cm</em></p><p></p><p></p><h1>Potassium (K)</h1><p>Potash is produced worldwide in amounts exceeding 90 million tonnes per year (40 million tonnes potassium oxide, K2O), with Canada being the largest producer, mostly for use in fertilizer.</p><p>Various kinds of fertilizer-potash constitute the single greatest industrial use of the element potassium in the world. </p><p>Potassium was first derived in 1807 by electrolysis of caustic potash (potassium hydroxide, KOH).</p><p>Potassium is the chemical element with the symbol K (from Neo-Latin kalium) and atomic number 19.</p><p>It is a silvery white metal that is soft enough to easily cut with a knife.</p><p>Potassium metal reacts rapidly with atmospheric oxygen to form flaky white potassium peroxide in only seconds of exposure. </p><p>It was first isolated from potash, the ashes of plants, from which its name derives.</p><p>In the periodic table, potassium is one of the alkali metals, all of which have a single valence electron in the outer electron shell, which is easily removed to create an ion with a positive charge (which combines with anions to form salts).</p><p>In nature, potassium occurs only in ionic salts. Elemental potassium reacts vigorously with water, generating sufficient heat to ignite hydrogen emitted in the reaction, and burning with a lilac-colored flame. </p><p>It is found dissolved in seawater (which is 0.04% potassium by weight), and occurs in many minerals such as orthoclase, a common constituent of granites and other igneous rocks.</p><p>Potassium ions are vital for the functioning of all living cells. </p><p>The transfer of potassium ions across nerve cell membranes is necessary for normal nerve transmission; potassium deficiency and excess can each result in numerous signs and symptoms, including an abnormal heart rhythm and various electrocardiographic abnormalities.</p><p>Fresh fruits and vegetables are good dietary sources of potassium. </p><p>The body responds to the influx of dietary potassium, which raises serum potassium levels, by shifting potassium from outside to inside cells and increasing potassium excretion by the kidneys.</p><p>Most industrial applications of potassium exploit the high solubility of its compounds in water, such as saltwater soap. </p><p>Heavy crop production rapidly depletes the soil of potassium, and this can be remedied with agricultural fertilizers containing potassium, accounting for 95% of global potassium chemical production.</p><blockquote><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link\" href=\"https://en.wikipedia.org/wiki/Potassium\">Potassium - Wikipedia</a></p></blockquote>",
