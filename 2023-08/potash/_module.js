...
function create_fragment$a(ctx) {
	...
	component_6 = new Component$7({
			props: {
				...
				description: "pot ash",
				content: {
					"html": "<p><em>Potassium pearls under paraffin oil. Original size of the largest pearl: 0.5&nbsp;cm</em></p><p></p><h1>Potassium (K)</h1><p>Potash is produced worldwide in amounts exceeding 90 million tonnes per year (40 million tonnes potassium oxide, K2O), with Canada being the largest producer, mostly for use in fertilizer. Various kinds of fertilizer-potash constitute the single greatest industrial use of the element potassium in the world. Potassium was first derived in 1807 by electrolysis of caustic potash (potassium hydroxide, KOH).</p><p>heading 3</p><p>Try it out today and see the difference for yourself. Overall, our calendar software is a comprehensive and effective tool for managing your time.</p><blockquote><p>Some interesting quote info</p></blockquote>",
					"markdown": "*Potassium pearls under paraffin oil. Original size of the largest pearl: 0.5 cm*\n\n\n\n# Potassium (K)\n\nPotash is produced worldwide in amounts exceeding 90 million tonnes per year (40 million tonnes potassium oxide, K2O), with Canada being the largest producer, mostly for use in fertilizer. Various kinds of fertilizer-potash constitute the single greatest industrial use of the element potassium in the world. Potassium was first derived in 1807 by electrolysis of caustic potash (potassium hydroxide, KOH).\n\nheading 3\n\nTry it out today and see the difference for yourself. Overall, our calendar software is a comprehensive and effective tool for managing your time.\n\n> Some interesting quote info\n\n"
				}
			}
		});
