...
function create_fragment$b(ctx) {
	...
	component_5 = new Component$6({
			props: {
				...
				description: "food of foods",
				content: {
					"html": "<p><strong>so i am in penang now</strong></p>\n<p><strong>i've had two of the 'best' laksas in KL already.</strong></p>\n<p>both were in the central market area. i forget what it's called, just a couple stops from main KL transport interchange..</p>\n<p>anyway, everyone kept saying, the best laksa is in penang.</p>\n<p>so i am in penang now.</p>\n<p>fantastic place, so many cool things, cool places, cool people.</p>\n<p>and you know what.</p>\n<p>what happens when you ask people in penang, where abouts is the best penang food? more specifically, i asked, where in penang is the best laksa?</p>\n<p>let me tell you about penang hill. you go up a 45 degree train. on top are the sweetest durians in the world. did you know that?</p>\n<p>there is a also a most beautiful buddhist temple, with monk quarters.</p>\n<p>and not just here but in another place. a very special place..</p>\n<p>you will get a bus to here. i did, and perhaps, if fortunes smile, i shall live here.</p>\n<p>they have a wishing well and lovely chinese zodiac garden.</p>\n<p>there is the largest statue of the goddess of mercy i've ever seen..</p>\n<p>near the entrance to this temple is where the best laksa was made.</p>\n<p>it still may be. it's been quite a while since i was there.</p>\n<p>when i was there, this was the place.</p>\n<p>and i ate there. it was the greatest food i've ever had. it's hard to rank that. and i did.</p>",
	...
	component_7 = new Component$8({
			props: {
				...
				image: {
					"alt": "laksas",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/laksas.webp1691555891597"
				},
				title: "laksa",
				description: "food of foods",
				superhead: "this is just a tribute",
				heading: ""
			}
		});
