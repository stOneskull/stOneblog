...
function create_fragment$9(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "food of foods",
				content: {
					"html": "<p><strong>the best food in the world is in malaysia</strong></p><p><em>the best food in malaysia in penang</em></p>",
	...
	component_5 = new Component$6({
			props: {
				...
				description: "food of foods",
				content: {
					"html": "<p><strong>so i am in penang now</strong></p><p><strong>i've had two of the 'best' laksas already.</strong></p><p>both in the central market area. i forget what it's called, just a couple stops from main KL transport interchange.</p><p>anyway, everyone kept saying, the best laksa is in penang. </p><p>so i am in penang now.</p><p>fantastic place, so many cool things, cool places, cool people.</p><p></p>",
