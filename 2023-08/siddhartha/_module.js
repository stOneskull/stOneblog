...
function create_fragment$g(ctx) {
	...
	component_10 = new Component$b({
			props: {
				...
				description: "2 men",
				content: {
					"html": "<p>like my writer's block, i've had reader's block for a very long time.</p><p>i've only been able to read non-fiction.</p><p>i'm loving reading again.</p><p></p><p></p><blockquote><p>calm the mind and read..</p></blockquote>",
					"markdown": "like my writer's block, i've had reader's block for a very long time.\n\ni've only been able to read non-fiction.\n\ni'm loving reading again.\n\n\n\n\n\n> calm the mind and read..\n\n"
				}
			}
		});
