...
function create_fragment$c(ctx) {
	...
	component_2 = new Component$3({
			props: {
				...
				title: "harvest moon",
				description: "september full moon",
				superhead: "2023-09-29",
				heading: "harvest moon"
			}
		});
	...
	component_4 = new Component$5({
			props: {
				...
				description: "september full moon",
				content: {
					"html": "<blockquote>\n  <p>The full Moon names used by&nbsp;<em>The Old Farmer’s Almanac</em>&nbsp;come from a number of places, including Native American, Colonial American, and European sources.</p>\n</blockquote>\n<p><a href=\"https://www.almanac.com/content/full-moon-september\">almanac.com/content/full-moon-september</a></p>",
					"markdown": "> The full Moon names used by *The Old Farmer’s Almanac* come from a number of places, including Native American, Colonial American, and European sources.\n\n[almanac.com/content/full-moon-september](<https://www.almanac.com/content/full-moon-september>)\n\n"
				}
			}
		});
	...
	component_5 = new Component$6({
			props: {
				...
				description: "september full moon",
				content: {
					"html": "<blockquote><p>The full Moon that happens nearest to the fall equinox (September 22 or 23) always takes on the name “Harvest Moon.” Unlike other full Moons, this full Moon rises at nearly the same time—around sunset—for several evenings in a row, giving farmers several extra evenings of moonlight and allowing them to finish their harvests before the frosts of fall arrive.</p><p>While September’s full Moon is usually known as the Harvest Moon, if October’s full Moon happens to occur closer to the equinox than September’s, it takes on the name “Harvest Moon” instead. In this case, September’s full Moon is referred to as the Corn Moon.</p></blockquote><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://www.almanac.com/content/full-moon-september\">almanac.com/content/full-moon-september</a></p>",
					"markdown": "> The full Moon that happens nearest to the fall equinox (September 22 or 23) always takes on the name “Harvest Moon.” Unlike other full Moons, this full Moon rises at nearly the same time—around sunset—for several evenings in a row, giving farmers several extra evenings of moonlight and allowing them to finish their harvests before the frosts of fall arrive.\n> \n> While September’s full Moon is usually known as the Harvest Moon, if October’s full Moon happens to occur closer to the equinox than September’s, it takes on the name “Harvest Moon” instead. In this case, September’s full Moon is referred to as the Corn Moon.\n\n[almanac.com/content/full-moon-september](<https://www.almanac.com/content/full-moon-september>)\n\n"
				}
			}
		});
	...
	component_8 = new Component$9({
			props: {
				...
				description: "september full moon",
				content: {
					"html": "<blockquote>\n  <p><a href=\"https://www.popsugar.com/smart-living/harvest-moon-meaning-48645903\">What September's Harvest Moon Means for Your Astrological Sign</a></p>\n</blockquote>",
					"markdown": "> [What September's Harvest Moon Means for Your Astrological Sign](<https://www.popsugar.com/smart-living/harvest-moon-meaning-48645903>)\n\n"
				}
			}
		});
