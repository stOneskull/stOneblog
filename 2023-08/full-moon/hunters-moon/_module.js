...
function create_fragment$b(ctx) {
	...
	component_4 = new Component$5({
			props: {
				...
				description: "october full moon",
				content: {
					"html": "<blockquote><p>The full Moon names used by&nbsp;<em>The Old Farmer’s Almanac</em>&nbsp;come from a number of places, including Native American, Colonial American, and European sources.</p></blockquote><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://www.almanac.com/content/full-moon-october\">https://www.almanac.com/content/full-moon-october</a></p>",
					"markdown": "> The full Moon names used by *The Old Farmer’s Almanac* come from a number of places, including Native American, Colonial American, and European sources.\n\n[https://www.almanac.com/content/full-moon-october](<https://www.almanac.com/content/full-moon-october>)\n\n"
				}
			}
		});
	...
	component_5 = new Component$6({
			props: {
				...
				description: "october full moon",
				content: {
					"html": "<blockquote><p>The Harvest Moon is the full Moon that occurs nearest to the autumnal equinox date (September 23, 2023). This means that either September or October’s full Moon may take on the name “Harvest Moon” instead of its traditional name. Similarly, the Hunter’s Moon is the first full Moon to follow the Harvest Moon, meaning it can occur in either October or November.</p><p>This year, the Harvest Moon occurred on September 29, so the Hunter’s Moon will follow it one lunar cycle later, on October 28.</p><p></p><p><strong>Why Is It Called the Hunter’s Moon?</strong></p><p>This particular full Moon is commonly referred to as the full Hunter’s Moon. It is believed that this name originates from the fact that it was a signal for hunters to prepare for the upcoming cold winter by going hunting. This is because animals were beginning to fatten up in preparation for the winter season. Moreover, since fields had recently been cleared out under the Harvest Moon, hunters could easily spot deer and other animals that had come out to search for remaining scraps. Additionally, foxes and wolves would also come out to prey on these animals.</p><p>The earliest use of the term “Hunter’s Moon,” cited in the Oxford English Dictionary, is from 1710. Some sources suggest that other names for the Hunter’s Moon are the Sanguine or Blood Moon, either associated with the blood from hunting or the color of the changing autumn leaves. </p></blockquote><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://www.almanac.com/content/full-moon-october\">https://www.almanac.com/content/full-moon-october</a></p>",
					"markdown": "> The Harvest Moon is the full Moon that occurs nearest to the autumnal equinox date (September 23, 2023). This means that either September or October’s full Moon may take on the name “Harvest Moon” instead of its traditional name. Similarly, the Hunter’s Moon is the first full Moon to follow the Harvest Moon, meaning it can occur in either October or November.\n> \n> This year, the Harvest Moon occurred on September 29, so the Hunter’s Moon will follow it one lunar cycle later, on October 28.\n> \n> \n> \n> **Why Is It Called the Hunter’s Moon?**\n> \n> This particular full Moon is commonly referred to as the full Hunter’s Moon. It is believed that this name originates from the fact that it was a signal for hunters to prepare for the upcoming cold winter by going hunting. This is because animals were beginning to fatten up in preparation for the winter season. Moreover, since fields had recently been cleared out under the Harvest Moon, hunters could easily spot deer and other animals that had come out to search for remaining scraps. Additionally, foxes and wolves would also come out to prey on these animals.\n> \n> The earliest use of the term “Hunter’s Moon,” cited in the Oxford English Dictionary, is from 1710. Some sources suggest that other names for the Hunter’s Moon are the Sanguine or Blood Moon, either associated with the blood from hunting or the color of the changing autumn leaves.\n\n[https://www.almanac.com/content/full-moon-october](<https://www.almanac.com/content/full-moon-october>)\n\n"
				}
			}
		});
	...
	component_6 = new Component$7({
			props: {
				...
				description: "october full moon",
				heading: "Astrology",
				subheading: "Hunter's Moon",
				cards: [
					{
						"stat": "Libra",
						"title": "Constellation"
					},
					{ "stat": "Venus", "title": "Planet" }
				]
			}
		});
	...
	component_7 = new Component$8({
			props: {
				...
				description: "october full moon",
				content: {
					"html": "<blockquote>\n  <p><a href=\"https://people.com/october-hunters-full-moon-2023-zodiac-sign-everything-to-know-8363222\">What October's Hunter's Moon Means for Your Astrological Sign</a></p>\n</blockquote>",
					"markdown": "> [What October's Hunter's Moon Means for Your Astrological Sign](<https://people.com/october-hunters-full-moon-2023-zodiac-sign-everything-to-know-8363222>)\n\n"
				}
			}
		});
