...
function create_fragment$f(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "definition b but super",
				content: {
					"html": "<h1>Today</h1><p><em>11:36am Sydney time / 1:36am UTC / 9:36pm (Aug 30) New York time</em></p><p></p><p><strong><br>There are 12 Full Moons</strong></p><p></p><p>Around the world, people have given names to the full moons through the year.</p><p>In America, the native American people's names of Full Moons are used a lot, such as the Sturgeon Moon for August.</p><p></p><p>Because a lunar month is 29.5 days, 12 lunar months is shorter than a solar year.</p><p>Every 2 or 3 years, a 13th full moon will be in the year.</p><p>There wasn't a traditional name for it, and it became the Blue Moon</p><p></p><p><em>Which of the 13 full moons in the year is the blue moon?</em></p><p>Well, if you think of four seasons in a year, each season should have 3 full moons.</p><p>The blue moon is in the season with four full moons.</p>",
	...
	component_6 = new Component$7({
			props: {
				...
				description: "definition b but super",
				content: {
					"html": "<p>The moon doesn't go around the Earth in a perfect circle.</p><p>When the moon comes closest to the Earth in its elliptical orbit, <br>it is called a Super Moon</p><p>This August 2023 monthly blue moon is a super moon too.</p><p>A super monthly blue moon</p><p>or simply, a Super Blue Moon</p>",
					"markdown": "The moon doesn't go around the Earth in a perfect circle.\n\nWhen the moon comes closest to the Earth in its elliptical orbit, <br>\n\nit is called a Super Moon\n\nThis August 2023 monthly blue moon is a super moon too.\n\nA super monthly blue moon\n\nor simply, a Super Blue Moon\n\n"
				}
			}
		});
	...
	component_7 = new Component$8({
			props: {
				...
				description: "definition b but super",
				content: {
					"html": "<p><em>What about the third meaning?</em></p><p></p><p>Sometimes, if the atmospheric conditions are right, the moon can appear to be blue in colour.</p>",
					"markdown": "*What about the third meaning?*\n\n\n\nSometimes, if the atmospheric conditions are right, the moon can appear to be blue in colour.\n\n"
				}
			}
		});
	...
	component_8 = new Component$9({
			props: {
				...
				description: "definition b but super",
				content: {
					"html": "<blockquote><p>In the aftermath of the massive 1884 volcanic eruption of Krakatoa, a tremendous cloud of ash and dust was injected into the stratosphere (5 to 30 miles above the Earth's surface); this aerosol cloud caused both the moon and sun to appear blue from many locations in the Northern Hemisphere for many months after the explosion.&nbsp;&nbsp;</p><p>On&nbsp;September 24th, 1950, a 200-mile-wide swath of smoke from a series of smoldering fires in the forests of Northern Alberta in Canada cast an awesome pall over the Great Lakes, parts of New York State and Southern New England. The smoke produced an unusual midday darkness and caused the disk of the sun to shine in eerie hues of pink, blue and even purple!</p></blockquote><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link\" href=\"https://www.space.com/15455-blue-moon.html\">https://www.space.com/15455-blue-moon.html</a></p>",
					"markdown": "> In the aftermath of the massive 1884 volcanic eruption of Krakatoa, a tremendous cloud of ash and dust was injected into the stratosphere (5 to 30 miles above the Earth's surface); this aerosol cloud caused both the moon and sun to appear blue from many locations in the Northern Hemisphere for many months after the explosion.\n> \n> On September 24th, 1950, a 200-mile-wide swath of smoke from a series of smoldering fires in the forests of Northern Alberta in Canada cast an awesome pall over the Great Lakes, parts of New York State and Southern New England. The smoke produced an unusual midday darkness and caused the disk of the sun to shine in eerie hues of pink, blue and even purple!\n\n[https://www.space.com/15455-blue-moon.html](<https://www.space.com/15455-blue-moon.html>)\n\n"
				}
			}
		});
	...
	component_11 = new Component$c({
			props: {
				...
				description: "definition b but super",
				content: {
					"html": "<blockquote>\n  <p><a href=\"https://www.wmagazine.com/life/super-full-moon-august-2023-meaning-horoscope-manifestation\">What August’s Super Full Moon Means for Your Astrological Sign</a></p>\n</blockquote>",
					"markdown": "> [What August’s Super Full Moon Means for Your Astrological Sign](<https://www.wmagazine.com/life/super-full-moon-august-2023-meaning-horoscope-manifestation>)\n\n"
				}
			}
		});
