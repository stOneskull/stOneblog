...
function create_fragment$9(ctx) {
	...
	let t2;
	let t3;
	let if_block = /*image*/ ctx[0].url && create_if_block$5(ctx);
...
function create_each_block$2(key_1, ctx) {
	...
	let if_block = /*activeItem*/ ctx[2] === /*i*/ ctx[11] && create_if_block$7(ctx);
...
function instance$e($$self, $$props, $$invalidate) {
	...
	return [video_id, favicon, image, title, description];
}
...
function create_fragment$k(ctx) {
	...
	let if_block2 = /*mobileNavOpen*/ ctx[2] && create_if_block$b(ctx);
...
function create_fragment$m(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "hallelujah",
				content: {
					"html": "<h1>sweet krishna</h1><p></p><p><em>here is a short tale</em><br><em>on the life of lord krishna</em><br><em>inspired to inspire</em></p>",
					"markdown": "# sweet krishna\n\n\n\n*here is a short tale*<br>\n\n*on the life of lord krishna*<br>\n\n*inspired to inspire*\n\n"
				}
			}
		});
	...
	component_4 = new Component$5({
			props: {
				...
				image: {
					"alt": "baby krisna",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/babykrisna.jpg1692174981035"
				},
				title: "krisna",
				description: "hallelujah",
				superhead: "",
				heading: "baby krishna"
			}
		});
	...
	component_6 = new Component$7({
			props: {
				...
				image: {
					"alt": "krishna world",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/Vrajamandala%20Map.webp1692186522272"
				},
				title: "krisna",
				description: "hallelujah"
			}
	...
	component_7 = new Component$8({
			props: {
				...
				description: "hallelujah",
				content: {
					"html": "<p>Mathura is in the middle of the flower, near the river.</p><p>As a boy, he lived across the river in Gokula.</p>",
					"markdown": "Mathura is in the middle of the flower, near the river.\n\nAs a boy, he lived across the river in Gokula.\n\n"
				}
			}
		});
	...
	component_8 = new Component$9({
			props: {
				...
				image: {
					"alt": "safe krishna",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/babykrisna2.jpg1692175009778"
				},
				title: "krisna",
				description: "hallelujah",
				superhead: "",
				...
				items: [
					{
						"title": "1) Venu : ",
						"description": {
							"html": "<p><br>Small flute about 15cm with six holes. A whistling flute creating a divine sound vibration.\n<br>When Krishna plays the Venu, The four Vedas will come to collect the divine vibration from the sound.</p>\n<p>3) Vamsi: The Vamsi flute is about fifteen inches long, with nine holes on its body. The sound of Krishna’s Vamsi flute spreads in all four directions. Even though Krishna vibrates his flute within this universe, its sound pierces the universal covering and goes to the spiritual sky. Thus the vibration enters the ears of all inhabitants. It especially enters Goloka Vṛndāvana-dhāma and attracts the minds of the young damsels of Vrajabhūmi, bringing them forcibly to where Krishna is present.</p>\n<p>“OM VAMSHIDHARAAYA VIDHMAHEY – NAADHA VEDHAAYA DHEEMAHI – THANNO KRISHNA PRACHODHAYAATH “</p>\n<p>Krishna would play on any of these three flutes when they were needed. Krishna uses the Venu flute to attract Gopis, like Venum kvanantam from the Brahma Samhita. These flutes were sometimes bedecked with jewels, sometimes of hollow bamboo. When the flute is made of jewels it is called Sammohini. When made of gold, it is called Akarsini.</p>\n<p>Once when Krishna played all the three flutes simultaneously, it had an eight-fold effect – Firstly, Brahma and Shiva’s meditation was broken and they were mesmerised totally by the sound of Krishna’s flutes. Secondly, when Krishna played all the three flutes, the melody of the flutes made the Yamuna flow backwards. Thirdly, it made the moon stop moving. Fourthly, the flute tune made the cows run to Krishna and get stunned listening to the flute. The fifth, attracted gopis and made them come running to him. Sixth, made the stones melt and created autumn season. Seventhly, it manifested all seasons. Eighthly, Krishna’s flutes exclusively made Radha very happy.</p>",
							"markdown": "<br>Small flute about 15cm with six holes. A whistling flute creating a divine sound vibration.\n<br>When Krishna plays the Venu, The four Vedas will come to collect the divine vibration from the sound.\n\n\n\n3) Vamsi: The Vamsi flute is about fifteen inches long, with nine holes on its body. The sound of Krishna’s Vamsi flute spreads in all four directions. Even though Krishna vibrates his flute within this universe, its sound pierces the universal covering and goes to the spiritual sky. Thus the vibration enters the ears of all inhabitants. It especially enters Goloka Vṛndāvana-dhāma and attracts the minds of the young damsels of Vrajabhūmi, bringing them forcibly to where Krishna is present.\n\n“OM VAMSHIDHARAAYA VIDHMAHEY – NAADHA VEDHAAYA DHEEMAHI – THANNO KRISHNA PRACHODHAYAATH “\n\nKrishna would play on any of these three flutes when they were needed. Krishna uses the Venu flute to attract Gopis, like Venum kvanantam from the Brahma Samhita. These flutes were sometimes bedecked with jewels, sometimes of hollow bamboo. When the flute is made of jewels it is called Sammohini. When made of gold, it is called Akarsini.\n\nOnce when Krishna played all the three flutes simultaneously, it had an eight-fold effect – Firstly, Brahma and Shiva’s meditation was broken and they were mesmerised totally by the sound of Krishna’s flutes. Secondly, when Krishna played all the three flutes, the melody of the flutes made the Yamuna flow backwards. Thirdly, it made the moon stop moving. Fourthly, the flute tune made the cows run to Krishna and get stunned listening to the flute. The fifth, attracted gopis and made them come running to him. Sixth, made the stones melt and created autumn season. Seventhly, it manifested all seasons. Eighthly, Krishna’s flutes exclusively made Radha very happy."
						}
					},
					{
						"title": "2) Murali :",
						"description": {
							"html": "<p>Murali is about 45cm, has a hole at the end, and four holes on the body. It produces an enchanting sound.  A very enchanting sound. The moment Krishna starts playing the Murali flute, Shiva and Parvati will come and enjoy the sound.</p>\n<p><br>Mura is a demon’s name and Ari means enemy. Murari means one who removes enmity from one’s mind, one who destroys the enemies of his bhakthas. To one who always chants the name of Krishna, Krishna will play the Murali flute inside the atma or the soul. When Krishna's bhakthas pray to him to hear the sound of Murali, Krishna will play.</p>",
							"markdown": "Murali is about 45cm, has a hole at the end, and four holes on the body. It produces an enchanting sound.  A very enchanting sound. The moment Krishna starts playing the Murali flute, Shiva and Parvati will come and enjoy the sound.\n\n<br>Mura is a demon’s name and Ari means enemy. Murari means one who removes enmity from one’s mind, one who destroys the enemies of his bhakthas. To one who always chants the name of Krishna, Krishna will play the Murali flute inside the atma or the soul. When Krishna's bhakthas pray to him to hear the sound of Murali, Krishna will play.\n"
						}
					}
				]
			}
				...
				testimonials: [
					{
						"name": "Vishnu",
						"quote": {
							"html": "<p>Mura was son of Rishi Kashyapa. <br></p>\n<p>He received a boon from Brahma that whoever would be touched by his hands would die. <br></p>\n<p>After receiving this boon, he went on to challenge the Gods in individual combat. <br></p>\n<p>Everybody knew of the boon he had received, and nobody was willing to fight him. Thus, he won the Swarga without fighting a single war. <br></p>\n<p><br></p>\n<p>In the mean time, King Raghu of Raghuvansha, decided to perform a Yajna. Mura did not want this and wanted to destroy King Raghu, but Brahmarishi Vishwamitra intervened saying that, Raghu was not his equal, and that battles must be fought between equals.</p>\n<p><br></p>\n<p>Rishi Vishwamitra further advised Mura to challenge Yama. On hearing that Mura wanted to fight him, Yama fled to Vaikuntha and asked Lord Vishnu to help him. Lord Vishnu said that he would fight Mura in the place of Yama. Yama then met Mura and said Sri Hari would Fight Mura in his stead, asking him to wait at the shore of the ocean called Kshiroda, where Sri Hari would fight Him. <br></p>\n<p><br></p>\n<p>When Narayana and Mura met face to face, Mura started taunting him. <br></p>\n<p>In reply, Narayana said, “if you are feeling so brave Mura, then why is your heart beating so fast?”. <br></p>\n<p>On hearing this, Mura put his hand on his chest in order to refute Sri Hari’s claim. But the damage was done. He touched himself with his hand, and according to the boon from Brahma, anyone who was touched by Mura’s hand, irrespective of who the person was, would die. Thus, Narayana defeated Mura, and is thus called Murari.</p>",
							"markdown": "Mura was son of Rishi Kashyapa. <br>\n\nHe received a boon from Brahma that whoever would be touched by his hands would die. <br>\n\nAfter receiving this boon, he went on to challenge the Gods in individual combat. <br>\n\nEverybody knew of the boon he had received, and nobody was willing to fight him. Thus, he won the Swarga without fighting a single war. <br>\n\n<br>\n\nIn the mean time, King Raghu of Raghuvansha, decided to perform a Yajna. Mura did not want this and wanted to destroy King Raghu, but Brahmarishi Vishwamitra intervened saying that, Raghu was not his equal, and that battles must be fought between equals.\n\n<br>\n\nRishi Vishwamitra further advised Mura to challenge Yama. On hearing that Mura wanted to fight him, Yama fled to Vaikuntha and asked Lord Vishnu to help him. Lord Vishnu said that he would fight Mura in the place of Yama. Yama then met Mura and said Sri Hari would Fight Mura in his stead, asking him to wait at the shore of the ocean called Kshiroda, where Sri Hari would fight Him. <br>\n\n<br>\n\nWhen Narayana and Mura met face to face, Mura started taunting him. <br>\n\nIn reply, Narayana said, “if you are feeling so brave Mura, then why is your heart beating so fast?”. <br>\n\nOn hearing this, Mura put his hand on his chest in order to refute Sri Hari’s claim. But the damage was done. He touched himself with his hand, and according to the boon from Brahma, anyone who was touched by Mura’s hand, irrespective of who the person was, would die. Thus, Narayana defeated Mura, and is thus called Murari.\n\n"
						},
						"title": "shapeform"
					}
				]
	...
	component_12 = new Component$d({
			props: {
				...
				image: {
					"alt": "young krishna",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/youngkrishna.webp1692190782820"
				},
				title: "krisna",
				description: "hallelujah",
				superhead: "",
				heading: "young krishna"
			}
		});
	...
	component_16 = new Component$h({
			props: {
				...
				description: "hallelujah",
				content: {
					"html": "<p><em>what a great song.</em></p><p><em>i'm going to learn it on guitar.</em></p>",
					"markdown": "*what a great song.*\n\n*i'm going to learn it on guitar.*\n\n"
				}
			}
		});
	...
	component_17 = new Component$i({
			props: {
				...
				image: {
					"alt": "night krishna",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/nightkrisna.jpg1692175126685"
				},
				title: "krisna",
				description: "hallelujah",
				superhead: "",
				heading: "good night krishna"
			}
		});
