...
function create_fragment$e(ctx) {
	...
	let if_block = /*testimonials*/ ctx[1].length > 1 && create_if_block$9(ctx);
...
function create_fragment$k(ctx) {
	...
	let t2;
	let t3;
	let if_block = /*image*/ ctx[0].url && create_if_block$b(ctx);
...
function create_fragment$o(ctx) {
	...
	component_12 = new Component$d({
			props: {
				...
				description: "hallelujah",
				content: {
					"html": "<p></p><p>Krishna would play on any of his 3 flutes when they were needed.</p><p><br>These flutes were sometimes bedecked with jewels, sometimes of hollow bamboo.</p>",
				...
				testimonials: [
					{
						"name": "",
						"quote": {
							"html": "<p>Once when Krishna played all the three flutes simultaneously,</p><p>it had an eight-fold effect –<br><br></p><p>1- Brahma and Shiva’s meditation was broken and they were mesmerised totally by the sound of Krishna’s flutes.</p><p>2- when Krishna played all the three flutes, the melody of the flutes made the Yamuna flow backwards.</p><p>3- it made the moon stop moving.</p><p>4- the flute tune made the cows run to Krishna and get stunned listening to the flute.</p><p>5- attracted gopis and made them come running to him.</p><p>6- made the stones melt and created autumn season.</p><p>7- it manifested all seasons.</p><p>8- Krishna’s flutes exclusively made Radha very happy.<br><br></p><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://indianmyth.wordpress.com/2019/12/01/krishna-and-his-flutes\"><em>https://indianmyth.wordpress.com/2019/12/01/krishna-and-his-flutes</em></a></p>",
							"markdown": "Once when Krishna played all the three flutes simultaneously,\n\nit had an eight-fold effect –<br>\n\n<br>\n\n1- Brahma and Shiva’s meditation was broken and they were mesmerised totally by the sound of Krishna’s flutes.\n\n2- when Krishna played all the three flutes, the melody of the flutes made the Yamuna flow backwards.\n\n3- it made the moon stop moving.\n\n4- the flute tune made the cows run to Krishna and get stunned listening to the flute.\n\n5- attracted gopis and made them come running to him.\n\n6- made the stones melt and created autumn season.\n\n7- it manifested all seasons.\n\n8- Krishna’s flutes exclusively made Radha very happy.<br>\n\n<br>\n\n[*https://indianmyth.wordpress.com/2019/12/01/krishna-and-his-flutes*](<https://indianmyth.wordpress.com/2019/12/01/krishna-and-his-flutes>)\n\n"
						},
						"title": ""
					}
				]
