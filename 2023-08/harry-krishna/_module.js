...
function create_fragment$j(ctx) {
	...
	component_9 = new Component$a({
			props: {
				...
				description: "hallelujah",
				content: {
					"html": "<p>Krishna is known by other names. </p><p>Some names include: <br>Mohan (\"enchanter\"); <br>Govinda (\"chief herdsman\");<br>Keev (\"prankster\"); <br>Gopala (\"Protector of the 'Go'\", which means \"soul\" or \"the cows\").</p><p>Jagannatha is a form or incarnation of Krishna, <br>worshipped in the Puri Hindu temple, and surrounding areas in Eastern India.</p><p>Krishna can be referred to as: <br>Vāsudeva-Krishna, Murlidhar, or Chakradhar. </p><p>The honorary title \"Sri\" is used before his name.. </p><p>Shri Krishna</p>",
