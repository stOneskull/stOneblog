...
function create_fragment$8(ctx) {
	...
	component_4 = new Component$5({
			props: {
				...
				description: "These are my blog posts and they are wonderful.",
				content: {
					"html": "<p><em>Some more text that's italicized to make an impact.</em></p>\n<p>I've been writing pretend blogs in my mind.</p>\n<p>I've been doing stuff and thinking about a blog for the things.</p>\n<p>Like, I never had a NAS before. I never used RAID 1 with two drives in a NAS and stuff.</p>\n<p>I never bought a whole duck before. I've bought duck that's already cooked. Never my own blank slate duck. I've cooked many chickens. And I love it.</p>\n<p>I'm quite excited to cook my duck. There are so many paths that it could take. So many possibilities of where this duck will go. Before it goes in my mouth and stomach.</p>\n<p>Some blogs might be for my own viewing. It's all part of this journey thing.</p>\n<p>The NAS is exciting too. Gotta wait til the router and ethernet cables arrive. Then I'll do a post <a href=\"https://www.stoneskull.me/2023-08/lxd\">about it. --></a></p>\n<p><a href=\"https://www.stoneskull.me/2023-08/blogs/blogs-week-1\">blOgs week 1 --></a></p>",
					"markdown": "*Some more text that's italicized to make an impact.*\n\nI've been writing pretend blogs in my mind.\n\nI've been doing stuff and thinking about a blog for the things.\n\nLike, I never had a NAS before. I never used RAID 1 with two drives in a NAS and stuff.\n\nI never bought a whole duck before. I've bought duck that's already cooked. Never my own blank slate duck. I've cooked many chickens. And I love it.\n\nI'm quite excited to cook my duck. There are so many paths that it could take. So many possibilities of where this duck will go. Before it goes in my mouth and stomach.\n\nSome blogs might be for my own viewing. It's all part of this journey thing.\n\nThe NAS is exciting too. Gotta wait til the router and ethernet cables arrive. Then I'll do a post [about it. -->](https://www.stoneskull.me/2023-08/lxd)\n\n\n[blOgs week 1 -->](https://www.stoneskull.me/2023-08/blogs/blogs-week-1)"
				}
			}
		});
