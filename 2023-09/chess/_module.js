...
function create_fragment$7(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "ultimate strategy",
				content: {
					"html": "<h2>chess</h2><h4><em>i feckin love it..</em></h4><p></p><p>chess has no dice. it's just skill.</p><p>a few factors have to come into play, for someone to be the best.</p><p>over the years, the best players are widely considered to be bobby fischer, gary kasparov, and magnus carlsen.</p><p>without argue, if you put all three together in their prime, magnus will win. it would be such an epic battle. but magnus was influenced by fischer and kasparov and would ultimately have the upper hand.</p><p>magnus is the best ever. and fischer and kasparov are an important part of him and the history and chess.</p><p>the few factors needed are:</p><p>visualisation.. firstly you gotta be able to imagine the board and the pieces moving in your mind. you need to breathe the chess, to be able to comfortably play blindfolded.</p><p>branched-futures.. this is calculation.. when they say you gotta look 4 moves ahead, it is an exponential rather than a linear 4 steps. each step has branches.. 4 moves ahead is a tree. you gotta be able to see these trees, where the game can branch. and then each branch can have branches. this is chess skill and comes with devotion and practice.</p><p>memory.. the better you can remember, not just your own past games, but the games of others, the better you will play. magnus carlsen has a photographic memory of all the games like this. this factor is ultimately why he is the best. as well as:</p><p>practice.. this is where we see the new-school coming in. able to play hundreds of games per day, people have the internet. this is new, relatively. magnus was just in time to be able to do well in the computer chess, but the new generations are showing their skill in this factor. it reminds me of when the internet poker boom happened. a whole new group of talent emerged.</p><p>creativity.. the ability to evaluate the position.. to find the best move.. to combine attack, defense, combinations, pinning, skewering, and all the other tricks and traps possible.</p><p></p><p>chess is the best.</p><p></p><p></p>",
