...
function create_fragment$8(ctx) {
	...
	component_4 = new Component$5({
			props: {
				...
				description: "first",
				content: {
					"html": "<h1>Primo Day..</h1><p></p><p><em>To make my blog, I use a thing called Primo. It's a bit like Wordpress.</em></p><p><em>You know, you might see at the bottom of a site: This site was made by Wordpress. </em><br><em>Well, as a default, there would be a site made by Primo thing at the bottom of this. </em></p><p><em>I really appreciate FOSS products including Primo, but I don't want to distract away from my blog with the message on every page. So I thought I could at least put the message on once a month, and give Primo a little mention. </em></p><p><em>So the first of the month is Primo day!</em></p><p></p><p></p>",
