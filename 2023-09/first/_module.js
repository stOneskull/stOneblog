...
function create_fragment$8(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "first",
				content: {
					"html": "<h1>Nice..</h1><p></p><p><em>New moonth</em></p><p>A new beginning.</p><p>I was trying to write a blog each and every day.</p><p>I just about did it for August. It was cool but I'm not going to do it anymore. I'm going to do them when I feel like it now, rather than feel like I need to do them.</p><p>The ones I do do, I can put more time into, and I can put some time into the older blogs, adding more to them.</p><p>In the southern hemisphere, we come into Spring! I love it!</p><p>Autumn is beautiful too!</p><p>Equinox equanimity. Solstice serenity. Vice versas.</p><p></p><p></p>",
	...
	component_4 = new Component$5({
			props: {
				...
				description: "first",
				content: {
					"html": "<h1 id=\"primoday\">Primo Day..</h1>\n<p><em>To make my blog, I use a thing called Primo. It's a bit like Wordpress.</em></p>\n<p><em>You know, you might see at the bottom of a site: This site was made by Wordpress.</em><br></p>\n<p><em>Well, as a default, there would be a site made by Primo thing at the bottom of this.</em></p>\n<p><em>I really appreciate FOSS products including Primo, but I don't want to distract away from my blog with the message on every page. So I thought I could at least put the message on once a month, and give Primo a little mention.</em></p>\n<p><em>So the first of the month is <a href=\"https://primo.so\">Primo</a> day!</em></p>",
					"markdown": "# Primo Day..\n\n\n\n*To make my blog, I use a thing called Primo. It's a bit like Wordpress.*\n\n*You know, you might see at the bottom of a site: This site was made by Wordpress.*<br>\n\n*Well, as a default, there would be a site made by Primo thing at the bottom of this.*\n\n*I really appreciate FOSS products including Primo, but I don't want to distract away from my blog with the message on every page. So I thought I could at least put the message on once a month, and give Primo a little mention.*\n\n*So the first of the month is [Primo](https://primo.so) day!*\n\n\n\n\n\n"
				}
			}
		});
