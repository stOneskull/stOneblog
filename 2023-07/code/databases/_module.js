...
function create_fragment$a(ctx) {
	...
	component_5 = new Component$6({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<p></p><p><strong>Bases</strong></p><p><em>addicted to base</em></p><p>when i was about 13, i got an amiga. i tried a database for the time.</p><p>maybe it was just a spreadsheet and they called it a database... i'll have to research that.. it's a long time ago to recall..</p><p>i typed in all my comics. i had started collecting, and i even put each comic in a special bag with a backing board. later on, at 15, i'd go on to work at the comic store. and that's another story.</p><p>i enjoyed having each comic, with its writer and penciller and inker.. i started to appreciate the other creators. i still remember ranking the letterers. todd klein is totally the best ever. and i give my special mention to stan sakai. </p><p>being able to sort the comics was cool. and the different ways of sorting. i dug it.</p><p>i haven't really found much use for databases since then. i've done data entry for work, and i've played around with connecting python with sql.. mainly to just try it.</p><p>now i want a database. and not sql. </p><p>i'm leaning to that odd one out in the picture. pretty much in the centre of the picture.</p><p></p><p>and then i found dr chuck..</p><p></p>",
					"markdown": "\n\n**Bases**\n\n*addicted to base*\n\nwhen i was about 13, i got an amiga. i tried a database for the time.\n\nmaybe it was just a spreadsheet and they called it a database... i'll have to research that.. it's a long time ago to recall..\n\ni typed in all my comics. i had started collecting, and i even put each comic in a special bag with a backing board. later on, at 15, i'd go on to work at the comic store. and that's another story.\n\ni enjoyed having each comic, with its writer and penciller and inker.. i started to appreciate the other creators. i still remember ranking the letterers. todd klein is totally the best ever. and i give my special mention to stan sakai.\n\nbeing able to sort the comics was cool. and the different ways of sorting. i dug it.\n\ni haven't really found much use for databases since then. i've done data entry for work, and i've played around with connecting python with sql.. mainly to just try it.\n\nnow i want a database. and not sql.\n\ni'm leaning to that odd one out in the picture. pretty much in the centre of the picture.\n\n\n\nand then i found dr chuck..\n\n\n\n"
				}
			}
		});
