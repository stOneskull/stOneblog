...
function create_fragment$h(ctx) {
	...
	component_4 = new Component$5({
			props: {
				...
				image: {
					"alt": "bases",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/th-3443318014.jpg1692790199603"
				},
				title: "databases",
				description: "step by step",
				superhead: "",
	...
	component_5 = new Component$6({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<p><strong>Tables</strong></p><p><em>addicted to base</em></p><p>when i was about 14, i got an amiga. i tried a database for the first time.</p><p>maybe it was just a spreadsheet and they called it a database… i'll have to research that.. it's a long time ago to recall..</p><p>i typed in all my comics. i had started collecting quite a bit, and i even put each comic in a special bag with a backing board. later on, at 15, i'd go on to work at the comic store.</p><p>i enjoyed having each comic in the database, with its details like writer and penciller and inker.. i started to appreciate the other creators of a comic too. i still remember ranking the letterers. todd klein is totally the best ever. and i give my special mention to stan sakai. groo is my favourite comic.</p><p>being able to sort the comics was cool. and the different ways of sorting. i really dug it. and it made it easy to see the holes in my collection. which issues i needed. without having to look at the comics themselves.</p><p>i haven't really found much use for databases since then though. spreadsheets are good enough, or text files, or python dictionaries. i've done data entry for work, and i've played around with connecting python with sql.. mainly to just try it.. and to avoid learning sql.</p><p>now i want a database. and not sql.</p><p></p><p>i don't want a headache thinking about JOINs and stuff. </p><p>i want to change the schema willy-nilly.</p><p>i want to try something new.</p><p>and the data that i'm going to fill all your base up with is documents..</p><p>it's suited.</p><p>so, no sql.</p><p></p><p>i'm leaning toward that odd one out in the picture above.</p><p>pretty much in the centre of the picture.</p><p>humongous..</p>",
	...
	component_7 = new Component$8({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<p><strong>Document-oriented database</strong></p><p><em>orientated</em></p><p>sounds good to me already</p><p></p><p>there are two or three branches here.. <br>eg. xml.. well, we can scratch that one anyway..</p><p>we could talk about graph-databases.. they seem cool</p><p>they are nodes and connections.. edges..</p><p></p><p>i might have a couple contenders.</p><p>i think i want an embed-able database..<br>each player with their own in their game..</p><p></p>",
					"markdown": "**Document-oriented database**\n\n*orientated*\n\nsounds good to me already\n\n\n\nthere are two or three branches here.. <br>\n\neg. xml.. well, we can scratch that one anyway..\n\nwe could talk about graph-databases.. they seem cool\n\nthey are nodes and connections.. edges..\n\n\n\ni might have a couple contenders.\n\ni think i want an embed-able database..<br>\n\neach player with their own in their game..\n\n\n\n"
				}
			}
		});
	...
	component_10 = new Component$b({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<pre><code>&gt;&gt;&gt; from unqlite import UnQLite\n&gt;&gt;&gt; db = UnQLite()  # Create an in-memory database.</code></pre><p></p>",
	...
	component_11 = new Component$c({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<h3 id=\"keyvaluefeatures\">Key/value features</h3>\n<p>UnQLite can be used as a key/value store.</p>",
					"markdown": "###Key/value features\n\nUnQLite can be used as a key/value store.\n\n\n\n"
				}
			}
		});
	...
	component_12 = new Component$d({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<pre><code>&gt;&gt;&gt; db['foo'] = 'bar'  # Use as a key/value store.\n&gt;&gt;&gt; db['foo']  # The key/value store deals in byte-strings.\nb'bar'\n\n&gt;&gt;&gt; for i in range(4):\n...     db['k%s' % i] = str(i)\n...\n\n&gt;&gt;&gt; 'k3' in db\nTrue\n&gt;&gt;&gt; 'k4' in db\nFalse\n&gt;&gt;&gt; del db['k3']\n\n&gt;&gt;&gt; db.append('k2', 'XXXX')\n&gt;&gt;&gt; db['k2']\nb'2XXXX'</code></pre><p></p>",
	...
	component_13 = new Component$e({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<h3>Cursors</h3><p>For finer-grained record traversal, you can use cursors.</p><p><em>read more here:</em> <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://github.com/coleifer/unqlite-python\"><em>https://github.com/coleifer/unqlite-python</em></a></p>",
					"markdown": "### Cursors\n\nFor finer-grained record traversal, you can use cursors.\n\n*read more here:* [*https://github.com/coleifer/unqlite-python*](<https://github.com/coleifer/unqlite-python>)\n\n"
				}
			}
		});
