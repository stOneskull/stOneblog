...
function create_fragment$a(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<p><em>i don't wanna talk about no sql..</em></p><p><strong>Key-Value</strong></p><p>For me, that is easy to understand. A dictionary. JSON.<br>JSON pretty much is a dictionary, and doesn't look gross like XML</p><p>Javascript is pretty gross. JSON should change its name. to something-else-ON</p><p>Anyway, let's look at different databases.</p><p><strong>main types and main software..</strong></p>",
					"markdown": "*i don't wanna talk about no sql..*\n\n**Key-Value**\n\nFor me, that is easy to understand. A dictionary. JSON.<br>\n\nJSON pretty much is a dictionary, and doesn't look gross like XML\n\nJavascript is pretty gross. JSON should change its name. to something-else-ON\n\nAnyway, let's look at different databases.\n\n**main types and main software..**\n\n"
				}
			}
		});
