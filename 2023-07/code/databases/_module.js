...
function create_fragment$a(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<p><em>i don't wanna talk about no sql..</em></p><p><strong>Key-Value</strong></p><p>For me, that is easy to understand. A dictionary. JSON.<br>JSON pretty much is a dictionary, and doesn't look gross like XML</p><p>Javascript is pretty gross. </p><p>JSON should change its name. to Something-Else-ON</p><p>Anyway, let's look at different databases.</p><p><strong>main types and main software..</strong></p>",
	...
	component_4 = new Component$5({
			props: {
				...
				image: {
					"alt": "bases",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/th-3443318014.jpeg1692787536600"
				},
				title: "databases",
				description: "step by step",
				superhead: "",
	...
	component_5 = new Component$6({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<p></p><p><strong>Bases</strong></p><p><em>addicted to base</em></p><p>when i was about 13, i got an amiga. i tried a database for the first time.</p><p>maybe it was just a spreadsheet and they called it a database... i'll have to research that.. it's a long time ago to recall..</p><p>i typed in all my comics. i had started collecting quite a bit, and i even put each comic in a special bag with a backing board. later on, at 15, i'd go on to work at the comic store. and that's another story.</p><p>i enjoyed having each comic in the database, with its details like writer and penciller and inker.. i started to appreciate the other creators of a comic too. i still remember ranking the letterers. todd klein is totally the best ever. and i give my special mention to stan sakai. groo is my favourite comic.</p><p>being able to sort the comics was cool. and the different ways of sorting. i really dug it. and it made it easy to see the holes in my collection. which issues i needed. without having to look at the comics themselves.</p><p>i haven't really found much use for databases since then though. spreadsheets are good enough, or text files, or python dictionaries. i've done data entry for work, and i've played around with connecting python with sql.. mainly to just try it.. and to avoid learning sql. there's a thing called sqlalchemy and you can interact with the sql database in a python way.</p><p>now i want a database. and not sql. </p><p>i don't need the headache. it's not like i'm a data scientist who needs strict table configurations, etc.. or i've got important fucking census information i need to keep secure, and running efficiently, scaled and distributed across multiple servers, blah blah blah.. it gives me 64 headaches..</p><p>so no sql.</p><p>i'm leaning to that odd one out in the picture above. pretty much in the centre of the picture.</p><p></p><p>and then i found dr chuck..</p><p></p>",
					"markdown": "\n\n**Bases**\n\n*addicted to base*\n\nwhen i was about 13, i got an amiga. i tried a database for the first time.\n\nmaybe it was just a spreadsheet and they called it a database... i'll have to research that.. it's a long time ago to recall..\n\ni typed in all my comics. i had started collecting quite a bit, and i even put each comic in a special bag with a backing board. later on, at 15, i'd go on to work at the comic store. and that's another story.\n\ni enjoyed having each comic in the database, with its details like writer and penciller and inker.. i started to appreciate the other creators of a comic too. i still remember ranking the letterers. todd klein is totally the best ever. and i give my special mention to stan sakai. groo is my favourite comic.\n\nbeing able to sort the comics was cool. and the different ways of sorting. i really dug it. and it made it easy to see the holes in my collection. which issues i needed. without having to look at the comics themselves.\n\ni haven't really found much use for databases since then though. spreadsheets are good enough, or text files, or python dictionaries. i've done data entry for work, and i've played around with connecting python with sql.. mainly to just try it.. and to avoid learning sql. there's a thing called sqlalchemy and you can interact with the sql database in a python way.\n\nnow i want a database. and not sql.\n\ni don't need the headache. it's not like i'm a data scientist who needs strict table configurations, etc.. or i've got important fucking census information i need to keep secure, and running efficiently, scaled and distributed across multiple servers, blah blah blah.. it gives me 64 headaches..\n\nso no sql.\n\ni'm leaning to that odd one out in the picture above. pretty much in the centre of the picture.\n\n\n\nand then i found dr chuck..\n\n\n\n"
				}
			}
		});
