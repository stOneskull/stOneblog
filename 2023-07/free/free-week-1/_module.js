...
function create_fragment$7(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "step by step",
				content: {
					"html": "<p><-- <a href=\"https://www.stoneskull.me/2023-07/free\">previous week</a> - <a href=\"https://www.stoneskull.me/2023-07/free/free-we-too\">next week</a> --></p>\n<h4 id=\"2things\"><em>2 things</em></h4>\n<h2 id=\"de\"><strong>De-</strong></h2>\n<h3 id=\"googolizize\"><strong>• Googolizize</strong></h3>\n<h3 id=\"windowsizize\"><strong>• Windowsizize</strong></h3>\n<p>a week now..</p>\n<p>i've started to chip at the first thing.</p>\n<p>the second thing seems to get harder each day.</p>\n<h3 id=\"phase2\"><strong>phase 2:.</strong></h3>\n<p>G:</p>\n<p>i'll start with the biggest uses of me logging in with gmail..</p>\n<ul>\n<li><p>twitter</p></li>\n<li><p>github</p></li>\n</ul>\n<!-- -->\n<p>then where i log in <em>with</em> these</p>\n<p>i have a few of those.</p>\n<p>it reminded me of a place <a href=\"http://exercism.org\">exercism.org</a></p>\n<p>cool place.. but i log in with github there.</p>\n<p>then i realised it doesn't matter about that!</p>\n<p>if i change the email with github and twitter then these others don't need to know about that. it should just work the same.</p>\n<p>this still might be a lengthy project, especially as i have 3 gmails i have done many a-logins with.. these accounts through the years..</p>\n<p>another one that i just got reminded of that i probably wouldn't have thought about was a vs code extension. it's a membership to use it. i hadn't used that extension in ages and it popped up on my radar again the other day. of course, i could probably make a new account if worse came to worse but it's a bit annoying. especially if there's history in the account i want to keep.</p>\n<p>W:</p>\n<p>i use wsl a lot. i have ongoing projects tied to it.</p>\n<p>very tricky to get me stuck, uncle ms</p>\n<p>if i do my laptop first it will be good.</p>\n<p>also, i think i may be able to just upload wsl stuff into an ubuntu cloud then redownload it into the new proper linux installation.</p>\n<p>i'm not gonna give up.</p>\n<p>bitwarden for passwords and authentication</p>\n<p>i currently use a mix of browser saved and another password manager saved. this manager is mainly a browser extension. it's on the phone too but doesn't work too well.. but really, i don't have total trust in it. it's fine now and gets good reviews but what about futurewise..</p>\n<p>i haven't started with bitwarden yet. slow chipping with what i have and will process over soon.</p>\n<p>another post in a week</p>\n<p><a href=\"https://www.stoneskull.me/2023-07/free/free-we-too\">-- conclusion</a></p>",
					"markdown": "<-- [previous week](https://www.stoneskull.me/2023-07/free) - [next week](<https://www.stoneskull.me/2023-07/free/free-we-too>) -->\n\n\n\n#### *2 things*\n\n\n\n## **De-**\n\n### **• Googolizize**\n\n### **• Windowsizize**\n\n\n\na week now..\n\ni've started to chip at the first thing.\n\nthe second thing seems to get harder each day.\n\n\n\n### **phase 2:.**\n\nG:\n\ni'll start with the biggest uses of me logging in with gmail..\n\n- twitter\n\n- github\n\n\n<!-- -->\n\nthen where i log in *with* these\n\ni have a few of those.\n\nit reminded me of a place [exercism.org](<http://exercism.org>)\n\ncool place.. but i log in with github there.\n\nthen i realised it doesn't matter about that!\n\nif i change the email with github and twitter then these others don't need to know about that. it should just work the same.\n\nthis still might be a lengthy project, especially as i have 3 gmails i have done many a-logins with.. these accounts through the years..\n\nanother one that i just got reminded of that i probably wouldn't have thought about was a vs code extension. it's a membership to use it. i hadn't used that extension in ages and it popped up on my radar again the other day. of course, i could probably make a new account if worse came to worse but it's a bit annoying. especially if there's history in the account i want to keep.\n\nW:\n\ni use wsl a lot. i have ongoing projects tied to it.\n\nvery tricky to get me stuck, uncle ms\n\nif i do my laptop first it will be good.\n\nalso, i think i may be able to just upload wsl stuff into an ubuntu cloud then redownload it into the new proper linux installation.\n\ni'm not gonna give up.\n\nbitwarden for passwords and authentication\n\ni currently use a mix of browser saved and another password manager saved. this manager is mainly a browser extension. it's on the phone too but doesn't work too well.. but really, i don't have total trust in it. it's fine now and gets good reviews but what about futurewise..\n\ni haven't started with bitwarden yet. slow chipping with what i have and will process over soon.\n\nanother post in a week\n\n[\\-- conclusion](<https://www.stoneskull.me/2023-07/free/free-we-too>)\n\n"
				}
			}
		});
