...
function create_fragment$a(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "rolling rolling rollling",
				content: {
					"html": "<p>&lt;-- <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link link link link\" href=\"https://www.stoneskull.me/2023-07/free/free-we-too\">previous</a></p><h1>free 3</h1><p></p><p>i ended up putting pop os! on my laptop.</p><p>i don't mind it.</p><p>at first i wanted to change to kde or xforce.. and i don't like the automatic tiling.. i turned that off.</p><p>but it's alright.</p><p>i never really used gnome and i tried my first extension. i wanted to have different wallpaper on each workspace, and that's how i found a way to do it. sometimes it's fun just tweaking. it's good to finally get windows off of that laptop. battery use sucks. it's an old laptop but i was still getting 2-3 hours battery on windows. now it's just over an hour. i may switch distro eventually. i'm still thinking about it.</p><p>i came <em>this</em> close to learning vim. then i was going to go with emacs. now i'm going with neither. it was a nice fantasy dream. for a little while. i use a desktop and a laptop. i like that i can have vs code all magically connected, and with github, and stuff. i'm lazy like that. i'm still using filezilla instead of learning bash properly. oh well. i'm not too worried about that. what's important is the writing of the stuff.</p><p>i started this blog to write. to free my mind.</p><p>it's taken time away from the science and mathematics but brought me closer to them. coding has been put in the drawer for a spell but it will be fine blue cheese in the morning..</p><p>no pictures again today. kinda keyboard-orientated.</p><p>oriented?</p><p>typing on my mad keyboard. feeling free.</p>",
					"markdown": "<-- [previous](<https://www.stoneskull.me/2023-07/free/free-we-too>)\n\n# free 3\n\n\n\ni ended up putting pop os! on my laptop.\n\ni don't mind it.\n\nat first i wanted to change to kde or xforce.. and i don't like the automatic tiling.. i turned that off.\n\nbut it's alright.\n\ni never really used gnome and i tried my first extension. i wanted to have different wallpaper on each workspace, and that's how i found a way to do it. sometimes it's fun just tweaking. it's good to finally get windows off of that laptop. battery use sucks. it's an old laptop but i was still getting 2-3 hours battery on windows. now it's just over an hour. i may switch distro eventually. i'm still thinking about it.\n\ni came *this* close to learning vim. then i was going to go with emacs. now i'm going with neither. it was a nice fantasy dream. for a little while. i use a desktop and a laptop. i like that i can have vs code all magically connected, and with github, and stuff. i'm lazy like that. i'm still using filezilla instead of learning bash properly. oh well. i'm not too worried about that. what's important is the writing of the stuff.\n\ni started this blog to write. to free my mind.\n\nit's taken time away from the science and mathematics but brought me closer to them. coding has been put in the drawer for a spell but it will be fine blue cheese in the morning..\n\nno pictures again today. kinda keyboard-orientated.\n\noriented?\n\ntyping on my mad keyboard. feeling free.\n\n"
				}
			}
		});
	...
	component_4 = new Component$5({
			props: {
				...
				content: {
					...
					"markdown": "# and then\n\n\n\nkali..\n\ni tried a live installation on a usb stick but either the stick was too high of a capacity or it is a dud. i will try again very soon. i like the idea of having kali on a flash drive. i could stick it in any lappy with a heartbeat. shwing!\n\n\n\n"
				}
			}
		});
