...
function create_fragment$9(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "blackboard",
				content: {
					"html": "<p><em>Some more text that's italicized to make an impact.</em></p><p>Or just write in normal text.</p><p>Twitter is a part of X Corp and <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"http://x.com\">x.com</a> goes to Twitter.</p><p>The new logo is X written in what's called 'double-stroked', 'double-struck' or 'blackboard bold' as it is the way mathematics teachers write in big letters as representations of number sets. </p><p>For example, the real numbers set is written ℝ with the teacher writing with the long side of the chalk. </p><p>Apparently 𝕏 is sometimes used to denote an arbitrary <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://en.wikipedia.org/wiki/Metric_space\">metric space</a>, whatever that means.</p><p>The X window system that is at <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"http://x.org\">x.org</a> has a similar use of the blackboard X as a logo.</p><p></p>",
					"markdown": "*Some more text that's italicized to make an impact.*\n\nOr just write in normal text.\n\nTwitter is a part of X Corp and [x.com](<http://x.com>) goes to Twitter.\n\nThe new logo is X written in what's called 'double-stroked', 'double-struck' or 'blackboard bold' as it is the way mathematics teachers write in big letters as representations of number sets.\n\nFor example, the real numbers set is written ℝ with the teacher writing with the long side of the chalk.\n\nApparently 𝕏 is sometimes used to denote an arbitrary [metric space](<https://en.wikipedia.org/wiki/Metric_space>), whatever that means.\n\nThe X window system that is at [x.org](<http://x.org>) has a similar use of the blackboard X as a logo.\n\n\n\n"
				}
			}
		});
	...
	component_4 = new Component$5({
			props: {
				...
				description: "blackboard",
				content: {
					"html": "<p><em>Didn't really have a topic for today.</em></p><p>I'm working on a controversial post and really not sure if I should post it. I don't really want to get much into politics or religion on my site here. But I think this topic is important..</p><p> Tomorrow I think is a continuation of another post.. A 'weekly update' post I'm doing inside some posts.</p><p>So today I thought I'd mention 𝕏 </p><p>This is all the buzz, in the news.. I wonder if someone reads this in the future far away. I wonder what happens with all this... </p><p>I think Elon Musk planned to make twitter into <a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link link link\" href=\"http://x.com\">x.com</a> since before he bought it. The domain is his baby, he made sure to keep it when splitting up from Paypal. I kinda like it. A new change.</p><p>But anyway, clogging along..</p><p>I wonder what happens when I die.. on a few different levels. And topics..</p>",
					"markdown": "*Didn't really have a topic for today.*\n\nI'm working on a controversial post and really not sure if I should post it. I don't really want to get much into politics or religion on my site here. But I think this topic is important..\n\nTomorrow I think is a continuation of another post.. A 'weekly update' post I'm doing inside some posts.\n\nSo today I thought I'd mention 𝕏\n\nThis is all the buzz, in the news.. I wonder if someone reads this in the future far away. I wonder what happens with all this...\n\nI think Elon Musk planned to make twitter into [x.com](<http://x.com>) since before he bought it. The domain is his baby, he made sure to keep it when splitting up from Paypal. I kinda like it. A new change.\n\nBut anyway, clogging along..\n\nI wonder what happens when I die.. on a few different levels. And topics..\n\n"
				}
			}
		});
	...
	component_5 = new Component$6({
			props: {
				...
				description: "blackboard",
				content: {
					"html": "<p><em>oh shit, i forgot to mention..</em></p><p>the lovely X at the top of the page is from the super swell font:</p><p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://www.fontspace.com/transatlantic-cruise-font-f22974\">transatlantic cruise</a></p>",
					"markdown": "*oh shit, i forgot to mention..*\n\nthe lovely X at the top of the page is from the super swell font:\n\n[transatlantic cruise](<https://www.fontspace.com/transatlantic-cruise-font-f22974>)\n\n"
				}
			}
		});
