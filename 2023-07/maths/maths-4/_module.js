...
class Component$j extends SvelteComponent {
	constructor(options) {
		...
		init(this, options, instance$j, null, safe_not_equal, {
			favicon: 0,
			image: 1,
			title: 2,
			description: 3
...
function create_fragment$j(ctx) {
	...
	component_6 = new Component$7({
			props: {
				...
				description: "square",
				content: {
					"html": "<p><em>zero is where x meets y</em></p><p>whatever that means. the x line and the y line must be invisible. no thickness.</p><p>my goodness, how can zero exist?</p><p><em>yeah it's an infinitely smol point. it doesn't really exist. </em></p><p><em>but like time, nothing exists without it</em></p>",
					"markdown": "*zero is where x meets y*\n\nwhatever that means. the x line and the y line must be invisible. no thickness.\n\nmy goodness, how can zero exist?\n\n*yeah it's an infinitely smol point. it doesn't really exist. *\n\n*but like time, nothing exists without it*\n\n"
				}
			}
		});
	...
	component_7 = new Component$8({
			props: {
				...
				description: "square",
				content: {
					"html": "<h1>head flosses</h1><p><em>we have a fishing line for x and a fishing line for y</em></p><p><em>x is horizontal and y is vertical and they are perpendicularrr</em></p><p><em>you know the thing.. it's just a model.. and we need it for 2D shapes, baby</em></p>",
					"markdown": "# head flosses\n\n*we have a fishing line for x and a fishing line for y*\n\n*x is horizontal and y is vertical and they are perpendicularrr*\n\n*you know the thing.. it's just a model.. and we need it for 2D shapes, baby*\n\n"
				}
			}
		});
	...
	component_8 = new Component$9({
			props: {
				...
				image: {
					"alt": "plane",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/th-1570528412.jpeg1692806844717"
				},
				title: "maths 4",
				description: "square"
			}
	...
	component_9 = new Component$a({
			props: {
				...
				description: "square",
				content: {
					"html": "<h1>The Plane</h1><p><em>let's put our head at zero</em></p><p></p><p>imagine putting your head at the centre of the plane</p><p>and the fishing line of x is going through your ears</p><p>the y line going straight through the top of your dome</p><p>your ears are level with zero, the line going perfectly straight through</p><p></p><p>you move your head slowly left, ears remaining level</p><p>the line rubs against the insides of your nose and the back of your eyes as it glides through your brain. your eyes and nose have entered the negative number zone, left of zero.</p><p>now, come back to the right, and slide your head past zero. go to about 2.3</p><p>then slowly back to -2.3, hold it there a second, and then go right to 2.3</p><p>repeat this left-and-right flossing your head, for about 5 minutes</p><p></p><p>you see? you didn't need to keep your ears level.</p><p>you can tilt your head the next time you floss, if it is more comfortable.</p><p>the lines just need to be perpendicularrr</p><p>imagine a protractorrr <br>start the propellerrr<br>rrroll your arrrs</p><p>the dual vibrations help with flossing, similarly to an electric toothbrush</p><p>shake that dementia dust off of your pineal gland</p>",
					"markdown": "# The Plane\n\n*let's put our head at zero*\n\n\n\nimagine putting your head at the centre of the plane\n\nand the fishing line of x is going through your ears\n\nthe y line going straight through the top of your dome\n\nyour ears are level with zero, the line going perfectly straight through\n\n\n\nyou move your head slowly left, ears remaining level\n\nthe line rubs against the insides of your nose and the back of your eyes as it glides through your brain. your eyes and nose have entered the negative number zone, left of zero.\n\nnow, come back to the right, and slide your head past zero. go to about 2.3\n\nthen slowly back to -2.3, hold it there a second, and then go right to 2.3\n\nrepeat this left-and-right flossing your head, for about 5 minutes\n\n\n\nyou see? you didn't need to keep your ears level.\n\nyou can tilt your head the next time you floss, if it is more comfortable.\n\nthe lines just need to be perpendicularrr\n\nimagine a protractorrr <br>\n\nstart the propellerrr<br>\n\nrrroll your arrrs\n\nthe dual vibrations help with flossing, similarly to an electric toothbrush\n\nshake that dementia dust off of your pineal gland\n\n"
				}
			}
		});
	...
	component_10 = new Component$b({
			props: {
				...
				description: "square",
				content: {
					"html": "<h1>x and y</h1><p><em>x feels easier than y</em></p><p></p><p>can we do a vertical floss? sure. get in those nooks, crannies, and other angles.</p><p></p><p>you move your head slowly down below zero. and then up above zero.</p><p>imagine as your head moves up and down, that the x line, that is going through your ears, is moving up and down as well. where the x line meets the y line is the spot. the value of y. </p><p>when we floss left and right, the y line comes along, and measures the x value. </p><p>if we move in any diagonal, both lines continue to move with our head. </p><p>the centre of our head is the spot, measuring the x and y values.</p><p>let's put the spot back on zero and get our head back.</p><p>just in time to get shot through the eyes with z</p>",
					"markdown": "# x and y\n\n*x feels easier than y*\n\n\n\ncan we do a vertical floss? sure. get in those nooks, crannies, and other angles.\n\n\n\nyou move your head slowly down below zero. and then up above zero.\n\nimagine as your head moves up and down, that the x line, that is going through your ears, is moving up and down as well. where the x line meets the y line is the spot. the value of y.\n\nwhen we floss left and right, the y line comes along, and measures the x value.\n\nif we move in any diagonal, both lines continue to move with our head.\n\nthe centre of our head is the spot, measuring the x and y values.\n\nlet's put the spot back on zero and get our head back.\n\njust in time to get shot through the eyes with z\n\n"
				}
			}
		});
	...
	component_12 = new Component$d({
			props: {
				...
				description: "square",
				content: {
					"html": "<h1>x y z</h1><p><em>pop will north-east itself</em></p><p></p><p>now we can move our head anywhere!</p><p>we can walk, do cartwheels, climb a mountain..</p><p>our head marks the x, y, z values from zero..</p><p>wherever zero is</p><p>do x, y, z determine zero, or does zero determine them..</p><p></p><p>anyway, wherever we go in 3D, our head marks the spot with the three lines..</p><p>a line from zero, a length dimension, in any direction, to where your head at</p><p>this most direct line</p><p>the 4th line going through your head</p><p></p>",
					"markdown": "# x y z\n\n*pop will north-east itself*\n\n\n\nnow we can move our head anywhere!\n\nwe can walk, do cartwheels, climb a mountain..\n\nour head marks the x, y, z values from zero..\n\nwherever zero is\n\ndo x, y, z determine zero, or does zero determine them..\n\n\n\nanyway, wherever we go in 3D, our head marks the spot with the three lines..\n\na line from zero, a length dimension, in any direction, to where your head at\n\nthis most direct line\n\nthe 4th line going through your head\n\n\n\n"
				}
			}
		});
