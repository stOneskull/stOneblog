...
function create_fragment$i(ctx) {
	...
	component_6 = new Component$7({
			props: {
				...
				description: "triangles in circle",
				content: {
					"html": "<p></p><p>the vector will be 'pointing' at x = cos(30), y = sin(30)</p><p>the vector is also the hypotenuse of a triangle. and remember it is length 1</p><p>sin is opposite over hypotenuse. the right angle is a vertical line from the point<br>meeting the x line (the line where y==0)</p><p></p><p><em>what? how? why? i'm confused, mang.</em></p><p></p><p>here we are supposed to think about how an equilateral triangle with side lengths 1 has three 60 degrees angles..</p><p>and if you chop it in half you get a triangle with a right angle, a 30 degree angle and a 60 degree angle</p><p></p><p></p><p></p><p></p><p></p>",
