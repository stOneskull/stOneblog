...
function create_fragment$l(ctx) {
	...
	component_5 = new Component$6({
			props: {
				...
				image: {
					"alt": "30degree",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/30degree.webp1690078997969"
				},
				title: "maths - week 1",
				description: "triangles in circle",
				superhead: "",
	...
	component_6 = new Component$7({
			props: {
				...
				description: "triangles in circle",
				content: {
					"html": "<p></p><p>the vector will be 'pointing' at x = cos(30), y = sin(30)</p><p>the vector is also the hypotenuse of a triangle. and remember it is length 1</p><p>sin is opposite over hypotenuse. the right angle is a vertical line from the point<br>meeting the x line (the line where y==0)</p><p></p><p><em>what? how? why? i'm confused, mang.</em></p><p>don't worry.. me too.</p><p></p><p>here we are supposed to think about how an equilateral triangle with side lengths 1 has three 60 degrees angles..</p><p>and if you chop it in half you get a triangle with a right angle, a 30 degree angle and a 60 degree angle</p>",
	...
	component_7 = new Component$8({
			props: {
				...
				image: {
					"alt": "half-triangle",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/context_larger_200.webp1690952747551"
				},
				title: "maths - week 1",
				description: "triangles in circle",
				superhead: "",
	...
	component_8 = new Component$9({
			props: {
				...
				description: "triangles in circle",
				content: {
					"html": "<p>so the y value becomes a half.. 1/2</p><p>sin(30) == 1/2 or 0.5</p><p>a squared + b squared = 1 squared = 1</p><p>sin(30) .. 30 == opposite / hypotenuse and since hypotenuse is 1, just opposite = 1/2</p><p></p><p>bit of headache, but nearly.. cos is like sin's brother.. it's all good.</p><p></p><p>cos(30) = adjacent / hypotenuse =</p><p></p><p>a is the adjacent and c is the hypotenuse in: </p><p>a squared + b squared = c squared</p><p>we want to know the adjacent length.. </p><p>so switch the formula..</p><p>a squared = c squared - b squared</p><p></p><p>adjacent squared == 1 - 1/2 squared = 1 - 1/4 = 3/4</p><p></p><p>adjacent == square root of (3/4) = square root of 3 / square root of 4 <br>= (square root of 3) / 2</p><p>this is about 0.866</p><p></p><p>angle is 30.. x (horizontal) is root 3 over 2.. y (vertical) is 1/2.... (+0.866, +0.5)</p><p></p><p><em>60 degrees is like the flipside of 30 degrees</em></p><p>angle is 60.. x is 1/2.. y is root 3 over 2.... (+0.5, +0.866)</p>",
					"markdown": "so the y value becomes a half.. 1/2\n\nsin(30) == 1/2 or 0.5\n\na squared + b squared = 1 squared = 1\n\nsin(30) .. 30 == opposite / hypotenuse and since hypotenuse is 1, just opposite = 1/2\n\n\n\nbit of headache, but nearly.. cos is like sin's brother.. it's all good.\n\n\n\ncos(30) = adjacent / hypotenuse =\n\n\n\na is the adjacent and c is the hypotenuse in:\n\na squared + b squared = c squared\n\nwe want to know the adjacent length..\n\nso switch the formula..\n\na squared = c squared - b squared\n\n\n\nadjacent squared == 1 - 1/2 squared = 1 - 1/4 = 3/4\n\n\n\nadjacent == square root of (3/4) = square root of 3 / square root of 4 <br>\n\n= (square root of 3) / 2\n\nthis is about 0.866\n\n\n\nangle is 30.. x (horizontal) is root 3 over 2.. y (vertical) is 1/2.... (+0.866, +0.5)\n\n\n\n*60 degrees is like the flipside of 30 degrees*\n\nangle is 60.. x is 1/2.. y is root 3 over 2.... (+0.5, +0.866)\n\n"
				}
			}
		});
	...
	component_10 = new Component$b({
			props: {
				...
				description: "triangles in circle",
				content: {
					"html": "<p></p><p>now 45 degrees means the other angle must be 45 degrees as there is the right angle too. and the side lengths, a and b, are equal.</p><p>if you have a unit square, all sides are 1, and cut it diagonally in half, the hypotenuse is the square root of (1 squared + 1 squared), or square root of 2</p><p></p>",
	...
	component_11 = new Component$c({
			props: {
				...
				image: {
					"alt": "square",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/GzlQ8A6QySQq40WfkGgA_Square.webp1690953450454"
				},
				title: "maths - week 1",
				description: "triangles in circle",
				superhead: "",
	...
	component_12 = new Component$d({
			props: {
				...
				description: "triangles in circle",
				content: {
					"html": "<p></p><p>sine is opposite over hypotenuse..</p><p>1 / root 2</p><p>cosine is adjacent over hypotenuse..</p><p>1 / root 2</p><p></p><p><strong><em>1 / root 2</em></strong></p><p></p><p>what we do here is say root 2 / root 2 == 1</p><p></p><p><strong><em>1 / root 2</em></strong></p><p></p><p>root 2 * 1 == root 2</p><p>the root 2 * root 2 makes a 2</p><p>so it's (root 2) / 2</p><p></p><p>sin 45 is (square root of 2) / 2, and cos 45 is (square root of 2) / 2</p><p>x, y = 0.707, 0.707</p><p></p>",
	...
	component_13 = new Component$e({
			props: {
				...
				image: {
					"alt": "wheel",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/trigonometric_circle_sine_cosine.webp1690078608162"
				},
				title: "maths - week 1",
				description: "triangles in circle",
				superhead: "",
	...
	component_14 = new Component$f({
			props: {
				...
				description: "triangles in circle",
				content: {
					"html": "<p><em>maths for blondes lol</em></p><p><em>why not!</em></p><p></p>",
					"markdown": "*maths for blondes lol*\n\n*why not!*\n\n\n\n"
				}
			}
		});
	...
	component_15 = new Component$g({
			props: {
				...
				description: "triangles in circle",
				content: {
					"html": "<p><em>round and round.. what it is..</em></p><p></p>",
					"markdown": "*round and round.. what it is..*\n\n\n\n"
				}
			}
		});
