...
function create_fragment$d(ctx) {
	...
	component_9 = new Component$a({
			props: {
				...
				description: "tree",
				content: {
					"html": "<h1>The Tree</h1><p><em>i think i will give the tree a name..</em></p><p><em>let's talk about the tree.</em></p><p></p><p>the tree is the game. it is the universe.</p><p>it is the tree.</p><p>there are other trees. a tree belongs to the player. you are the center of the universe, and you can visit other players in their universe. they can visit you too. and you can both go visit me in my tree. when i say 'the tree', i mean your tree.</p><p>at the start of the game, the player starts at the root node of the tree. the player is not a node. the tree grows out of you. there is no tree but you and the root node at the start.</p><p>then you have a choice.. you can do nothing and stay put at the root.. or move on to the next node.. which is behind that door in front of you. is that one choice or two choices?</p><p>every player starts like that. but once the player opens the door, the tree becomes unique to the player. it grows with the player, in his or her adventure. </p><p>can u dig it?</p><p>as the player travels on his or her adventure, there may be a time when there is a connection of some type between their tree and the tree of another player. this is quite enthralling and exciting, isn't it. i think so.</p>",
					"markdown": "# The Tree\n\n*i think i will give the tree a name..*\n\n*let's talk about the tree.*\n\n\n\nthe tree is the game. it is the universe.\n\nit is the tree.\n\nthere are other trees. a tree belongs to the player. you are the center of the universe, and you can visit other players in their universe. they can visit you too. and you can both go visit me in my tree. when i say 'the tree', i mean your tree.\n\nat the start of the game, the player starts at the root node of the tree. the player is not a node. the tree grows out of you. there is no tree but you and the root node at the start.\n\nthen you have a choice.. you can do nothing and stay put at the root.. or move on to the next node.. which is behind that door in front of you. is that one choice or two choices?\n\nevery player starts like that. but once the player opens the door, the tree becomes unique to the player. it grows with the player, in his or her adventure.\n\ncan u dig it?\n\nas the player travels on his or her adventure, there may be a time when there is a connection of some type between their tree and the tree of another player. this is quite enthralling and exciting, isn't it. i think so.\n\n"
				}
			}
		});
