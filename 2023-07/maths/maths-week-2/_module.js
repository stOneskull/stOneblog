...
function create_fragment$n(ctx) {
	...
	component_3 = new Component$4({
			props: {
				...
				description: "matrices",
				content: {
					"html": "<p><a target=\"_blank\" rel=\"noopener noreferrer nofollow\" class=\"link link\" href=\"https://www.stoneskull.me/2023-07/maths-week-1\">previous</a></p><p></p><h1>matrices</h1><p></p><p>this is where my submarine head is about half-way down to the titanic..</p><p>i can hear the fibres crackling.. but onward..</p><p><em>note: i don't know what i'm talking about. don't put this in your schoolwork.</em></p><p>1 can be represented as a 1x1 matrix [1] - that's interesting in itself!</p><p>[23] is 23</p><p>and a number by itself when interacting with the matrix is a scalar</p><p>a matrix is a set of numbers, in rows and columns, in a rectangular array.</p><p>you can have a square matrix, like 2x2, or 3x3.. <br></p><p>an n x n matrix.. <br></p><p>a square matrix to the order n</p><p>or if there are two rows and three columns, then it is a 2x3 matrix.</p><p>and m is used. it's an m x n matrix. <br></p><p>m is the rows and n is the columns.</p><p>[ 3 5 6]<br></p><p>[ 2 1 0 ] … a 2x3 matrix of some numbers.</p><p>transposing means making the rows into columns and the columns, rows.</p><p>[ 3 2 ]<br></p><p>[ 5 1 ]<br></p><p>[ 6 0 ]… a 3x2 matrix is the transpose of a 2x3 matrix</p>",
					"markdown": "[previous](<https://www.stoneskull.me/2023-07/maths-week-1>)\n\n\n\n# matrices\n\n\n\nthis is where my submarine head is about half-way down to the titanic..\n\ni can hear the fibres crackling.. but onward..\n\n*note: i don't know what i'm talking about. don't put this in your schoolwork.*\n\n1 can be represented as a 1x1 matrix [1] - that's interesting in itself!\n\n[23] is 23\n\nand a number by itself when interacting with the matrix is a scalar\n\na matrix is a set of numbers, in rows and columns, in a rectangular array.\n\nyou can have a square matrix, like 2x2, or 3x3.. <br>\n\nan n x n matrix.. <br>\n\na square matrix to the order n\n\nor if there are two rows and three columns, then it is a 2x3 matrix.\n\nand m is used. it's an m x n matrix. <br>\n\nm is the rows and n is the columns.\n\n[ 3 5 6]<br>\n\n[ 2 1 0 ] … a 2x3 matrix of some numbers.\n\ntransposing means making the rows into columns and the columns, rows.\n\n[ 3 2 ]<br>\n\n[ 5 1 ]<br>\n\n[ 6 0 ]… a 3x2 matrix is the transpose of a 2x3 matrix\n\n"
				}
			}
		});
