...
function create_fragment$8(ctx) {
	...
	component_2 = new Component$3({
			props: {
				...
				image: {
					"alt": "poles",
					"url": "https://ogfrjxqovwgsdzubizan.supabase.co/storage/v1/object/public/images/d6c182e2-29f7-45ec-a001-8b5fa4778f97/th-3033715559.jpeg1709527006373"
				},
				title: "ned kelly",
				description: "an interview",
				superhead: "2024-03-03",
				heading: "utility poles\n"
			}
		});
	...
	component_3 = new Component$4({
			props: {
				...
				description: "an interview",
				content: {
					"html": "<p><strong>utility poles</strong></p><p><em>some call them telephone poles or telegraph poles.</em></p>",
					"markdown": "**utility poles**\n\n*some call them telephone poles or telegraph poles.*\n\n"
				}
			}
		});
	...
	component_4 = new Component$5({
			props: {
				...
				description: "an interview",
				content: {
					"html": "<p><strong>sort of flippantly, kind of facetiously, i said twin peaks is a show about utility poles.</strong></p><p><strong>in a way it is though.</strong></p><p><strong>the logging of wood, the electricity, the markings of a highway..</strong></p><p><strong>telecommunication wires are also handled by the poles, although mainly it's alternating current electricity.</strong></p><p><strong>(more to come.. i just gotta get something down.. battling depression which sucks out the will to do anything..)</strong></p><p><strong>ps. thinking about light a lot. i need to get some question answered.. eg. does a light ray spin? does that spin make the electromagnetic waves? </strong></p><p></p>",
					"markdown": "**sort of flippantly, kind of facetiously, i said twin peaks is a show about utility poles.**\n\n**in a way it is though.**\n\n**the logging of wood, the electricity, the markings of a highway..**\n\n**telecommunication wires are also handled by the poles, although mainly it's alternating current electricity.**\n\n**(more to come.. i just gotta get something down.. battling depression which sucks out the will to do anything..)**\n\n**ps. thinking about light a lot. i need to get some question answered.. eg. does a light ray spin? does that spin make the electromagnetic waves? **\n\n\n\n"
				}
			}
		});
